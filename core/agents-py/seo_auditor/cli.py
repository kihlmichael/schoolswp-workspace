...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="DOSSIER",
        help=("Dossier de sauvegarde. Produit : audit-seo.md (rapport) + v2-fixed.md (si --fix déclenché)"),
    )
    parser.add_argument(
        "--output",
        default=None,
...
async def main() -> None:
    ...
    if args.fix:
        ...
        if result.fixed:
            ...
            print(
                f"  ✓ Audit {result.score_global}/100 → Correction déclenchée (V2 = {wc_v2} mots)",
                flush=True,
            )
        else:
            print(
