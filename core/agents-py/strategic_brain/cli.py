...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  1. knowledge_graph.cli        → content/docs/knowledge-graph.md\n"
    ...
    parser.add_argument(
        ...
        metavar="FICHIER",
        help=(
            "Cocon sémantique (.md) — produit par agents.cocon_builder.cli. Peut contenir plusieurs cocons concaténés."
        ),
    )
    parser.add_argument(
        "--roi-file",
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="TITRE",
        help=("Titres des articles déjà publiés. Exemples : --articles 'Tutor LMS vs LearnDash' 'FluentCRM guide'"),
    )
    parser.add_argument(
        "--output",
        default=None,
...
async def main() -> None:
    ...
    data_count = sum(1 for x in [graph_content, authority_content, cocon_content, roi_plan_content] if x)
