...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        metavar="OBJECTIF",
        help=(
            f"Objectif business prioritaire : {' | '.join(_OBJECTIVES)}. Oriente l'analyse du bloc Business alignment."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="DOSSIER",
        help=("Dossier de sauvegarde. Produit : conversion-audit.md + article-cta.md (si --inject)"),
    )
    parser.add_argument(
        "--output",
        default=None,
