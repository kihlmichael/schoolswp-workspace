...
Usage :
  ...
  python -m agents.content_factory.cli \\
    ...
    --pillar LMS \\
    --save-dir content/articles/lms-factory/
  ...
  python -m agents.content_factory.cli \\
    ...
    --save-dir content/articles/crm-factory/
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "    --pillar LMS --save-dir content/articles/lms-factory/\n\n"
            "  # Audit article existant\n"
            "  python -m agents.content_factory.cli \\\n"
            '    --file content/articles/lms-pilier/v3.md \\\n'
            '    --keyword "lms wordpress rentable" --intent décisionnelle \\\n'
            "    --pillar LMS --save-dir content/articles/lms-pilier/\n\n"
            "  # Génération + NER + SERP (pipeline complet)\n"
            "  python -m agents.content_factory.cli \\\n"
            '    --keyword "fluentcrm vs activecampaign" --intent comparative \\\n'
            "    --pillar CRM --include-serp --include-ner --save-dir content/articles/crm/"
        ),
    )
