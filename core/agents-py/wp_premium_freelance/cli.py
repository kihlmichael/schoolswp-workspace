...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Professeur IA WordPress Premium schoolsWP — positionner, concevoir et livrer des sites haut de gamme"
        ),
...
async def main() -> None:
    ...
    if args.list_topics:
        ...
        for b in _BUDGET_RANGES:
            print(f"  - {b}")
        print('\nUtilise : python -m agents.wp_premium_freelance.cli --topic "<sujet>" --client-profile "<profil>"\n')
        return
