...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Professeur IA WordPress Business schoolsWP — leçons orientées crédibilité, conversion et visibilité"
        ),
    ...
    parser.add_argument(
        ...
        metavar="PROJET",
        default=None,
        help=("Type de projet business (ex: 'site vitrine freelance graphiste', 'landing page offre coaching')"),
    )
    parser.add_argument(
        "--level",
        metavar="NIVEAU",
...
async def main() -> None:
    ...
    if args.list_topics:
        ...
        for p in _PROJECT_TYPES:
            print(f"  - {p}")
        print('\nUtilise : python -m agents.wp_business_teacher.cli --topic "<sujet>" --project "<projet>"\n')
        return
