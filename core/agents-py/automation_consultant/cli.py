...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "    --output content/articles/crm-onboarding-freelance.md\n\n"
            "  python -m agents.automation_consultant.cli \\\n"
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="OBJECTIF",
        help=("Ce qu'on veut automatiser (ex: 'tunnel de vente formation en ligne', 'CRM automatisé avec FluentCRM')"),
    )
    parser.add_argument(
        "--tools",
        nargs="+",
    ...
    parser.add_argument(
        ...
        metavar="CONTRAINTES",
        default=None,
        help=("Contraintes techniques ou budget (ex: 'budget < 50€/mois, hébergeur mutualisé, pas de Make')"),
    )
    parser.add_argument(
        "--output",
        metavar="FICHIER",
