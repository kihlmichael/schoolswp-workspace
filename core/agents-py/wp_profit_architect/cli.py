...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=("Architecte de Sites Rentables schoolsWP — WordPress orienté profit, conversion et ROI"),
...
async def main() -> None:
    ...
    if args.list_topics:
        ...
        for m in _BUSINESS_MODELS:
            print(f"  - {m}")
        print('\nUtilise : python -m agents.wp_profit_architect.cli --topic "<sujet>" --business-model "<modèle>"\n')
        return
