...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--keyword", required=True, metavar="MOT_CLÉ", help="Mot-clé SEO principal")
    parser.add_argument(
        "--intent",
        default=None,
        choices=_INTENTS,
    ...
    parser.add_argument(
        "--pillar", default=None, metavar="PILIER", help=f"Pilier thématique schoolsWP : {' | '.join(_PILLARS)}"
    )
    ...
    parser.add_argument("--output", default=None, metavar="FICHIER", help="Fichier unique pour le rapport d'audit")
