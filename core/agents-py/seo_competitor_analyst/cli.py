...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Consultant SEO Analyse Concurrentielle schoolsWP — gaps, quick wins, clusters, plan d'action expert"
        ),
    ...
    parser.add_argument(
        ...
        metavar="FOCUS",
        default=None,
        help=("Thématique prioritaire pour l'analyse (ex: 'LMS et formations', 'IA WordPress', 'automatisation')"),
    )
    parser.add_argument(
        "--output",
        metavar="FICHIER",
