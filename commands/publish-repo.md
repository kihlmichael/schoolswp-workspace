...
Purpose
- Create a GitHub repo, commit current changes, and push.
- Run only inside this repo: D:\VS Code\CLAUDE CODE\projects\schoolswp.

Usage
- /publish-repo <repo-name> [commit message]
...
7) Else create repo with gh:
   - gh repo create <repo-name> --source . --remote origin --private
