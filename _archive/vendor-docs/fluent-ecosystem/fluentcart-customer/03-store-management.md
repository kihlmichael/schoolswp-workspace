...
## Store Management - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/

[Skip to content](https://docs.fluentcart.com/guide/store-management/#VPContent)

# Store Management [​](https://docs.fluentcart.com/guide/store-management/\#store-management)
...
- **[Orders Management](https://docs.fluentcart.com/guide/store-management/orders-management/):** Learn how to view, filter, create, edit, refund, and collect payments for all orders.
- **[Customers Management](https://docs.fluentcart.com/guide/store-management/customers-management/):** Discover how to view, search, filter, and manage individual customer profiles and their associated data.
...
## Customers Management - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/customers-management/

[Skip to content](https://docs.fluentcart.com/guide/store-management/customers-management/#VPContent)

# Customers Management [​](https://docs.fluentcart.com/guide/store-management/customers-management/\#customers-management)
...
- **[Viewing & Searching Customers](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers):** Learn how to navigate the main Customers list and use search functionality to locate specific customer profiles.
- **[Using Advanced Customer Filters](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters):** Discover how to segment your customer base using powerful filtering options, such as purchase count and first purchase date.
- **[Customer Details Overview](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview):** A comprehensive guide to understanding all the information presented on an individual customer's profile page, including their orders, licenses, and contact details.
...
## Orders Management - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/#VPContent)

# Orders Management [​](https://docs.fluentcart.com/guide/store-management/orders-management/\#orders-management)
...
- **[Viewing & Filtering Orders](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders):** Learn how to navigate the main Orders list, use various filters to locate specific orders, and understand the different order statuses.
- **[Creating New Orders (Manually)](https://docs.fluentcart.com/guide/store-management/orders-management/creating-new-orders):** Steps to manually create an order directly from the backend, useful for phone orders or custom requests.
- **[Order Details Overview](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview):** A comprehensive guide to understanding all the information displayed on an individual order's detail page, including items, financial summaries, customer info, and activity logs.
- **[Editing Existing Orders](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders):** How to modify an order after it has been placed, including adding/removing products, adjusting quantities, and applying coupons.
- **[Processing Refunds](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds):** Detailed steps on how to issue full or partial refunds, with options to cancel associated subscriptions and revoke licenses.
- **[Collecting Payments for Modified Orders](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders):** How to collect outstanding balances after an order has been modified, including generating custom payment links and marking payments as received.
- **[Changing Order Statuses](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses):** Learn how to update the status of an order (e.g., Processing, Completed, On Hold, Canceled) and manage shipping statuses.
...
## FluentCart status Overview - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/understanding-statuses

[Skip to content](https://docs.fluentcart.com/guide/store-management/understanding-statuses#VPContent)

# FluentCart status Overview [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#fluentcart-status-overview)
...
#### 1\. Product status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_1-product-status)
...
#### 2\. Order status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_2-order-status)
...
#### 3\. Payment status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_3-payment-status)
...
#### 4\. Transaction status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_4-transaction-status)
...
#### 4\. Transaction Types [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_4-transaction-types)
...
#### 5\. Subscription status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_5-subscription-status)
...
#### 6\. Shipping status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#_6-shipping-status)
...
#### Customer status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#customer-status)
...
#### Stock status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#stock-status)
...
#### Billing Intervals [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#billing-intervals)
...
#### License status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#license-status)
...
#### Fulfillment Types [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#fulfillment-types)
...
#### Order Types [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#order-types)
...
#### Schedule status [​](https://docs.fluentcart.com/guide/store-management/understanding-statuses\#schedule-status)
...
## Customer Details Overview - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview

[Skip to content](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview#VPContent)

# Customer Details Overview [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#customer-details-overview)
...
Customers also have access to their own personalized dashboard where they can manage their profile, view orders, subscriptions, and licenses. For more details on what your customers see and can manage, refer to the [Customer Dashboard Profile Management](https://docs.fluentcart.com/guide/customer-dashboard/profile-management) documentation.

## Accessing Customer Details [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#accessing-customer-details)
...
## Understanding the Customer Details Screen [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#understanding-the-customer-details-screen)

The Customer Details screen is organized into several panels, each providing specific information about the customer.

### 1\. Customer Header [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#_1-customer-header)
...
### 2\. Customer Information Panel [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#_2-customer-information-panel)
...
### 3\. Orders Section [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#_3-orders-section)
...
- **Clickable Orders:** Each order ID is clickable, allowing you to quickly navigate to the [individual Order Details screen](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview) for that specific transaction.

### 4\. License Key Section [​](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview\#_4-license-key-section)
...
- **Clickable License Keys:** Each license key is clickable, allowing you to navigate to the [License Details screen](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products-with-licenses#product-specific-license-settings) for that specific license.
...
## Using Advanced Customer Filters - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters

[Skip to content](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters#VPContent)

# Using Advanced Customer Filters [​](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters\#using-advanced-customer-filters)
...
## Accessing and Using the Advanced Filter [​](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters\#accessing-and-using-the-advanced-filter)
...
## Defining Filter Criteria [​](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters\#defining-filter-criteria)
...
- **Adding Multiple Conditions:**
  ...
  - Click the **"\+ OR"** button to add an alternative filter condition. This allows you to find customers who meet _either_ the previous set of criteria _or_ the new one.
...
## Applying and Resetting Filters [​](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters\#applying-and-resetting-filters)
...
## Saving Custom Filter Views (New Feature!) [​](https://docs.fluentcart.com/guide/store-management/customers-management/using-advanced-customer-filters\#saving-custom-filter-views-new-feature)
...
2. **Name your view:** Give it a descriptive name (e.g., **"High LTV Customers"** or **"Recent Hoodie Buyers"**) and, optionally, a short description.
3. **Access anytime:** Open the **More views** dropdown beside your default tabs to quickly reuse your saved filters.
...
4. **Delete a view:** In the **More views** dropdown, click the trash icon next to a view name you no longer need.
...
## Viewing & Searching Customers - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers

[Skip to content](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers#VPContent)

# Viewing & Searching Customers [​](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers\#viewing-searching-customers)
...
## Accessing the Customers List [​](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers\#accessing-the-customers-list)
...
## Understanding the Customers List Table [​](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers\#understanding-the-customers-list-table)
...
## Finding Specific Customers [​](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers\#finding-specific-customers)
...
## Browsing Through Pages [​](https://docs.fluentcart.com/guide/store-management/customers-management/viewing-searching-customers\#browsing-through-pages)
...
## Changing Order Statuses - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses#VPContent)

# Changing Order Statuses [​](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses\#changing-order-statuses)
...
## Understanding Order Statuses [​](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses\#understanding-order-statuses)
...
## How to Change Order Status [​](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses\#how-to-change-order-status)

You can change an order's status and perform other related actions from the **[Order Details screen](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview)**.
...
3. From the dropdown, you will find several actions to manage the order's status:
   ...
   - **Cancel Order:** Selecting this option will mark the entire order as canceled. This often triggers stock adjustments and may be followed by a [refund process](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds) if payment was already received.
   - **Back to processing:** This action allows you to revert an order's status to "Processing." This is useful if an order was prematurely marked as "Completed" or "On Hold" and still requires further attention or [editing](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders).
...
### Using the Activity Log [​](https://docs.fluentcart.com/guide/store-management/orders-management/changing-order-statuses\#using-the-activity-log)
...
## Collecting Payments for Modified Orders - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders#VPContent)

# Collecting Payments for Modified Orders [​](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders\#collecting-payments-for-modified-orders)

When you [edit an existing order](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders) and add new products or increase quantities, the order's total value will increase. FluentCart gives flexible options to collect the outstanding balance from your customer.

## When to Collect Payment [​](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders\#when-to-collect-payment)

After you have [edited an order](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders) and are in the process of saving your changes (by clicking "Disable Editing"), if the order's total has increased, you will be prompted to collect the additional payment. The system will indicate a "Total Amount Due" or similar.

## Payment Collection Options [​](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders\#payment-collection-options)

To collect the outstanding balance, navigate to the **"Transaction Details"** section on the [Order Details screen](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview). You will see a **"Collect Payments"** dropdown menu.
...
### 1\. Custom Payment Link [​](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders\#_1-custom-payment-link)
...
### 2\. Mark Order as Paid [​](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders\#_2-mark-order-as-paid)
...
## Creating New Orders (Manually) - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/creating-new-orders

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/creating-new-orders#VPContent)

# Creating New Orders (Manually) [​](https://docs.fluentcart.com/guide/store-management/orders-management/creating-new-orders\#creating-new-orders-manually)
...
## Steps to Create a New Order [​](https://docs.fluentcart.com/guide/store-management/orders-management/creating-new-orders\#steps-to-create-a-new-order)
...
## Editing Existing Orders - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders#VPContent)

# Editing Existing Orders [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#editing-existing-orders)
...
## Entering Edit Mode [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#entering-edit-mode)

1. Navigate to the **[Order Details](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview)** screen for the specific order you wish to edit.
...
## Making Changes to an Order [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#making-changes-to-an-order)

Once in edit mode, you can perform various modifications to the order:

### 1\. Adding Products [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#_1-adding-products)
...
### 2\. Modifying Existing Order Items [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#_2-modifying-existing-order-items)
...
### 3\. Applying Coupons [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#_3-applying-coupons)
...
### 4\. Adding Shipping Costs [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#_4-adding-shipping-costs)
...
## Saving Your Changes [​](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders\#saving-your-changes)
...
1. Click the **"Disable Editing"** button in the top right corner.
   ...
   - If the order total has increased, you may be prompted to [collect additional payment](https://docs.fluentcart.com/guide/store-management/orders-management/collecting-payments-modified-orders).
...
## Instant Modal Checkout - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout#VPContent)

# Instant Modal Checkout [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#instant-modal-checkout)
...
## How it Works [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#how-it-works)
...
## Implementation Method 1: Using Custom Code (The Snippet Way) [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#implementation-method-1-using-custom-code-the-snippet-way)
...
### Configuring the Feature [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#configuring-the-feature)
...
### Understanding the Parameters [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#understanding-the-parameters)
...
## Implementation Method 2: The Gutenberg Block (The No-Code Way) [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#implementation-method-2-the-gutenberg-block-the-no-code-way)
...
### How to set it up: [​](https://docs.fluentcart.com/guide/store-management/orders-management/instant-modal-checkout\#how-to-set-it-up)
...
## Order Bump - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/order-bump

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump#VPContent)

# Order Bump [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#order-bump)
...
## 1\. Enabling the Order Bump Feature [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#_1-enabling-the-order-bump-feature)
...
### 2\. Creating a New Order Bump Offer [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#_2-creating-a-new-order-bump-offer)
...
### 3\. Configuring the Order Bump Details [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#_3-configuring-the-order-bump-details)

The Order Bump configuration screen is broken down into simple, manageable steps:

#### **A. Basic Info** [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#a-basic-info)
...
#### **B. Promotional Product** [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#b-promotional-product)
...
#### **C. Discount** [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#c-discount)
...
#### **D. Display Conditions (Detailed)** [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#d-display-conditions-detailed)
...
- **Adding Condition Groups:** The **Add New Condition Group** button allows you to set up separate, alternative sets of rules (OR logic). The bump will display if _any_ of the defined groups' conditions are met.

#### **E. Priority** [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#e-priority)
...
### 4\. Managing and Viewing Order Bumps [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump\#_4-managing-and-viewing-order-bumps)
...
## Order Details Overview - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview#VPContent)

# Order Details Overview [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#order-details-overview)
...
## Accessing Order Details [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#accessing-order-details)
...
## Understanding the Order Details Screen [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#understanding-the-order-details-screen)

The Order Details screen is organized into several panels, each providing specific information about the order.

### 1\. Order Header [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_1-order-header)
...
- **Refund Button:** Initiates the [refund process](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds) for the order.
- **Edit Button:** Allows you to enter [edit mode for the order](https://docs.fluentcart.com/guide/store-management/orders-management/editing-existing-orders).
...
### 2\. Order Items [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_2-order-items)
...
### 3\. Payment & Financial Summary [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_3-payment-financial-summary)
...
### 4\. Transaction Details [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_4-transaction-details)
...
### 5\. Customer Information [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_5-customer-information)
...
- This panel also offers quick links to [edit customer information](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview#editing-customer-information), [manage shipping address](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview#managing-customer-addresses), and [manage billing address](https://docs.fluentcart.com/guide/store-management/customers-management/customer-details-overview#managing-customer-addresses).
...
### 6\. Notes [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_6-notes)

A private field where administrators can add notes or comments related to the order.

### 7\. Activity Log [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_7-activity-log)
...
### 8\. UTM Details [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_8-utm-details)
...
### 9\. Tax Information [​](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview\#_9-tax-information)

This section on the sidebar shows the tax details the customer provided during checkout.

- **Tax ID:** Displays the customer's **Tax Identification** Number. This is especially useful for B2B (business-to-business) sales or for complying with regional tax regulations that require collecting this information. To learn more about Tax, read the [Documentation](https://docs.fluentcart.com/guide/tax-&-duties/configuration-and-classes/).
...
## Processing Refunds - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds#VPContent)

# Processing Refunds [​](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds\#processing-refunds)
...
## Steps to Process a Refund [​](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds\#steps-to-process-a-refund)

1. Navigate to the **[Order Details](https://docs.fluentcart.com/guide/store-management/orders-management/order-details-overview)** screen for the specific order you wish to refund.
...
## Post-Refund Status [​](https://docs.fluentcart.com/guide/store-management/orders-management/processing-refunds\#post-refund-status)
...
## Viewing & Filtering Orders - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders

[Skip to content](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders#VPContent)

# Viewing & Filtering Orders [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#viewing-filtering-orders)
...
## Accessing the Orders List [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#accessing-the-orders-list)
...
## Understanding the Orders List Table [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#understanding-the-orders-list-table)
...
## Customizing Your View & Actions [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#customizing-your-view-actions)
...
### Showing or Hiding Order Stats [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#showing-or-hiding-order-stats)
...
_(If you want to hide this summary to get more space on your screen, just click the dropdown again and choose the **Hide Order Stats** option)._

### Show Bulk Actions [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#show-bulk-actions)
...
### Delete Test Orders [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#delete-test-orders)
...
## Filtering Orders [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#filtering-orders)

FluentCart provides many ways to filter your orders, helping you narrow down the list based on status or other criteria.

### 1\. Filtering by Order Status [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#_1-filtering-by-order-status)
...
### 2\. Using the Advanced Filter [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#_2-using-the-advanced-filter)
...
### 3\. Using the Search Bar [​](https://docs.fluentcart.com/guide/store-management/orders-management/viewing-filtering-orders\#_3-using-the-search-bar)
