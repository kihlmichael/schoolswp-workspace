...
## Customer Dashboard - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/#VPContent)

# Customer Dashboard [​](https://docs.fluentcart.com/guide/customer-dashboard/\#customer-dashboard)
...
Ensure you have set the Customer Dashboard page from **FluentCart Pro** \> **Settings** \> **Pages Setup**, and your users can access their dashboard on that particular page. For detailed instructions on setting this up, please refer to our [Pages Setup documentation](https://docs.fluentcart.com/guide/settings-configuration/pages-setup).

## Key Sections of the Customer Dashboard [​](https://docs.fluentcart.com/guide/customer-dashboard/\#key-sections-of-the-customer-dashboard)
...
- **[View Purchase History (Orders & Payment Details)](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history)**: Provides a complete and detailed record of all past orders, including transaction details, payment statuses, and options to download invoices.
- **[Managing Subscriptions](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions)**: If you sell subscription products, this is where customers can view and control their recurring plans. They can check the status, see upcoming renewal dates, and manage other details.
- **[Managing Licenses](https://docs.fluentcart.com/guide/customer-dashboard/licenses)**: For software or other digital products that use license keys, this is a dedicated area for customers to find their keys, check activation limits, and see renewal information.
- **[Digital Product Downloads](https://docs.fluentcart.com/guide/customer-dashboard/downloads)**: This section gives customers a neat list of all the digital products they've purchased, with a simple download button next to each one.
- **[Update Profile Settings](https://docs.fluentcart.com/guide/customer-dashboard/profile-management)**: Where customers can update their personal contact information, manage billing addresses, and shipping addresses for future orders.
...
## Downloads - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/downloads

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/downloads#VPContent)

# Downloads [​](https://docs.fluentcart.com/guide/customer-dashboard/downloads\#downloads)
...
## How to Download Your Files [​](https://docs.fluentcart.com/guide/customer-dashboard/downloads\#how-to-download-your-files)

When you go to the Downloads page, you will see a simple list of all the files available to you. For each item, you'll see:

- **File Name:** This is the name of the downloadable file, like Creative\_Stock\_Pack\_Subscription.pdf.
...
## Licenses - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/licenses

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/licenses#VPContent)

# Licenses [​](https://docs.fluentcart.com/guide/customer-dashboard/licenses\#licenses)
...
## Viewing All Licenses [​](https://docs.fluentcart.com/guide/customer-dashboard/licenses\#viewing-all-licenses)
...
## Managing an Individual License [​](https://docs.fluentcart.com/guide/customer-dashboard/licenses\#managing-an-individual-license)
...
## Profile Management - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/profile-management

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/profile-management#VPContent)

# Profile Management [​](https://docs.fluentcart.com/guide/customer-dashboard/profile-management\#profile-management)
...
## Account Details [​](https://docs.fluentcart.com/guide/customer-dashboard/profile-management\#account-details)
...
## Billing Address [​](https://docs.fluentcart.com/guide/customer-dashboard/profile-management\#billing-address)
...
## Shipping Address [​](https://docs.fluentcart.com/guide/customer-dashboard/profile-management\#shipping-address)
...
## Edit an Existing Address [​](https://docs.fluentcart.com/guide/customer-dashboard/profile-management\#edit-an-existing-address)
...
## Purchase Confirmation & Invoice Receipt - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt#VPContent)

# Purchase Confirmation & Invoice Receipt [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#purchase-confirmation-invoice-receipt)
...
## Purchase Successful Page Overview [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#purchase-successful-page-overview)
...
### Invoice & Receipt Details [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#invoice-receipt-details)
...
If the purchased subscription includes a **Setup Fee**, it now appears as a clearly labeled line item on both the invoice receipt and the order confirmation email - so customers always know exactly what the one-time charge was for, on top of the recurring subscription price.
...
### Downloading the Invoice Receipt [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#downloading-the-invoice-receipt)
...
### Accessing the Order Later [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#accessing-the-order-later)
...
### Summary [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-confirmation-invoice-receipt\#summary)
...
## Purchase History - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/purchase-history

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history#VPContent)

# Purchase History [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history\#purchase-history)
...
## Viewing All Purchases [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history\#viewing-all-purchases)
...
## Searching Your Orders [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history\#searching-your-orders)
...
## Viewing Individual Order Details [​](https://docs.fluentcart.com/guide/customer-dashboard/purchase-history\#viewing-individual-order-details)
...
## Subscriptions - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/customer-dashboard/subscriptions

[Skip to content](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions#VPContent)

# Subscriptions [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#subscriptions)
...
### Viewing All Your Subscriptions [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#viewing-all-your-subscriptions)
...
### Managing an Individual Subscription [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#managing-an-individual-subscription)
...
#### Subscription Plan Details [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#subscription-plan-details)
...
#### Key Actions & Early Payments [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#key-actions-early-payments)
...
#### Related Transactions [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#related-transactions)
...
### What Happens When a Subscription Is Cancelled [​](https://docs.fluentcart.com/guide/customer-dashboard/subscriptions\#what-happens-when-a-subscription-is-cancelled)
