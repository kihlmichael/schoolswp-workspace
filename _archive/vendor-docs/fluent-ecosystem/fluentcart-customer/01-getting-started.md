...
## Dashboard Overview - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/getting-started/dashboard-overview

[Skip to content](https://docs.fluentcart.com/guide/getting-started/dashboard-overview#VPContent)

# Dashboard Overview [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#dashboard-overview)
...
For information on what your **customers** see when they log into their accounts, please refer to our [Customer Dashboard Overview](https://docs.fluentcart.com/guide/customer-dashboard/) documentation.
...
### Quick Access Controls (Top Right) [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#quick-access-controls-top-right)
...
## Key Dashboard Sections [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#key-dashboard-sections)

The dashboard is designed to give you instant insights into your store's health.

### 1\. Welcome & Quick Actions [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_1-welcome-quick-actions)
...
### 2\. Onboarding Checklist [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_2-onboarding-checklist)
...
### 3\. Store Key Metrics [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_3-store-key-metrics)
...
### 3\. Sales Growth Chart [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_3-sales-growth-chart)
...
### 5\. Recent Activities [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_5-recent-activities)
...
### 6\. Recent Orders [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_6-recent-orders)
...
- Includes a **View All** link to navigate to the full [Orders Management](https://docs.fluentcart.com/guide/store-management/orders-management/) screen for detailed management.

### 7\. Top Sold Products [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_7-top-sold-products)
...
### 8\. Order Heat Map [​](https://docs.fluentcart.com/guide/getting-started/dashboard-overview\#_8-order-heat-map)
...
## Glossary - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/getting-started/fluentcart-glossary

[Skip to content](https://docs.fluentcart.com/guide/getting-started/fluentcart-glossary#VPContent)

# Glossary [​](https://docs.fluentcart.com/guide/getting-started/fluentcart-glossary\#glossary)
...
- **Shortcode:** A small placeholder, enclosed in curly braces (e.g., `{order.id}`), used in email and document templates. FluentCart automatically replaces it with the corresponding dynamic information, such as a customer's name or order number.
...
## Initial Setup Wizard - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard

[Skip to content](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard#VPContent)

# Initial Setup Wizard [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#initial-setup-wizard)
...
## Steps of the Initial Setup Wizard [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#steps-of-the-initial-setup-wizard)

The FluentCart setup wizard guides you through the following crucial configurations to get your store up and running.

### 1\. Store Details [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#_1-store-details)
...
### 2\. Page Setup [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#_2-page-setup)
...
For each of these pages, you _must_ ensure the correct FluentCart shortcode is embedded in the page content for the functionality to work. The wizard typically prompts you or automatically adds them.
...
### 3\. Product Setup [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#_3-product-setup)
...
## Completing the Wizard & Next Steps for Your Business [​](https://docs.fluentcart.com/guide/getting-started/initial-setup-wizard\#completing-the-wizard-next-steps-for-your-business)
...
- **Setup Payment Gateways:** Set up your preferred payment methods like Stripe, PayPal, or Cash on Delivery under **[Payment Settings](https://docs.fluentcart.com/guide/settings-configuration/payment-settings)**.
- **Add Your Products:** Begin creating your actual [physical products](https://docs.fluentcart.com/guide/product-types-creation/creating-physical-products), [digital products](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products), or [licensed digital products](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products-with-licenses).
- **Review Email Notifications:** Customize your [email templates](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/index) to ensure customers receive branded and informative updates.
- **Explore Reports:** Utilize the [Reporting & Analytics](https://docs.fluentcart.com/guide/reporting-analytics/) section to monitor your store's performance.
...
## Installation & Activation - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/getting-started/installation-activation

[Skip to content](https://docs.fluentcart.com/guide/getting-started/installation-activation#VPContent)

# Installation & Activation [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#installation-activation)
...
#### Server & Hosting Requirements [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#server-hosting-requirements)
...
##### Minimum Requirements [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#minimum-requirements)

- **WordPress Version:** 5.0 or higher
- **PHP Version:** 7.4 or higher
- **MySQL Version:** 5.6 or higher (with InnoDB support)

## 1\. Installing FluentCart (Free Version) [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#_1-installing-fluentcart-free-version)
...
## 2\. Installing FluentCart Pro Addons (Requires Base Plugin) [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#_2-installing-fluentcart-pro-addons-requires-base-plugin)
...
## 3\. Activating Your FluentCart Pro Addons License [​](https://docs.fluentcart.com/guide/getting-started/installation-activation\#_3-activating-your-fluentcart-pro-addons-license)
...
6. Click the **"Verify License"** button. ![Screenshot of Licensing Settings Tab](https://docs.fluentcart.com/images/getting-started/install-activation/licensing-1.webp)
...
## Introduction to FluentCart - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/getting-started/introduction-fluentcart

[Skip to content](https://docs.fluentcart.com/guide/getting-started/introduction-fluentcart#VPContent)

# Introduction to FluentCart [​](https://docs.fluentcart.com/guide/getting-started/introduction-fluentcart\#introduction-to-fluentcart)
...
- **Sell Anything, Beautifully:** Create listings for [physical goods](https://docs.fluentcart.com/guide/product-types-creation/creating-physical-products), [digital downloads](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products), [recurring subscriptions](https://docs.fluentcart.com/guide/product-types-creation/managing-subscriptions), and even [licensed software](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products-with-licenses). Design your store exactly how you want using our intuitive [WordPress product blocks & templates](https://docs.fluentcart.com/guide/customization-and-themes/using-gutenberg-blocks).
- **Increase Every Sale with Built-in Marketing Tools:** Boost your average order value with one-click **[Order Bumps](https://docs.fluentcart.com/guide/marketing-sales-tools/)** at checkout, and drive sales with a powerful **[Coupon system](https://docs.fluentcart.com/guide/marketing-sales-tools/creating-managing-coupons/)** to attract and retain customers.
- **Automate Your Marketing and Save Time:** Put your marketing on autopilot. Connect seamlessly with tools like **[FluentCRM](https://docs.fluentcart.com/guide/integrations/fluentcrm-integration)** to automatically tag customers and start email sequences, or with **[FluentCommunity](https://docs.fluentcart.com/guide/integrations/fluentcommunity-integration)** to instantly grant access to members-only content upon purchase.
- **Make Smart Decisions with Clear Reports:** Get a clear view of your business with our clean and simple **[Reports dashboard](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)**. Understand your sales, revenue, and top-performing products so you can make data-driven decisions.
- **Global Sales:** Confidently sell to a global audience with flexible systems for **[Tax & Duties](https://docs.fluentcart.com/guide/tax-&-duties/tax-&-duties-overview)** and **[Shipping](https://docs.fluentcart.com/guide/shipping/)**. Configure country-specific rates, EU VAT rules, and shipping classes to stay compliant.
- **Offer a Checkout That Converts:** Don't lose customers at the final step. FluentCart's streamlined checkout process is designed for speed and security, with support for trusted payment gateways like **[Stripe](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/stripe-settings)**, **[PayPal](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/paypal-settings)**, and **[Paddle](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/)**.

## Getting Started [​](https://docs.fluentcart.com/guide/getting-started/introduction-fluentcart\#getting-started)

If you are new to FluentCart, we recommend starting with the [**Product Types & Creation**](https://docs.fluentcart.com/guide/product-types-creation/index) guides to learn how to add your first items to your store. From there, you can explore [**Payment Settings**](https://docs.fluentcart.com/guide/settings-configuration/payment-settings) and [**Shipping**](https://docs.fluentcart.com/guide/shipping/index) to get your store ready for its first sale.
