# Section Roadmaps & Goal Settings
...
URL : https://fluentboards.com/docs/fluentboards-roadmap-overview/
...
Now you’ll be redirected to your Roadmap Board. Here, you can add tasks, manage assignees, and handle other task-related settings that are similar to the normal** _Boards_ settings**. 
...
## Roadmap Settings
URL : https://fluentboards.com/docs/roadmap-settings/
