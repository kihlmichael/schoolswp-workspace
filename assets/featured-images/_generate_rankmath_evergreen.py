"""Regenerate the Rank Math review hero (2289943 FR) — evergreen pass (star-box variant)."""

import os

STAR = '<svg viewBox="0 0 24 24" fill="#00d400" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>'

HTML = """<!doctype html>
<html lang="fr">
  <head>
    <meta charset="UTF-8" />
    <title>Avis Rank Math - Hero FR</title>
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .title { font-family: "Inter", sans-serif; font-weight: 900; font-size: 104px; line-height: 0.96; letter-spacing: -4px; color: var(--black); }
      ...
      .visual-inner { padding: 56px 56px 48px 56px; display: flex; flex-direction: column; gap: 26px; height: 100%; }
      .verdict-card {
        border: 2px solid #a3e8a3; background: #f4fdf4; border-radius: 22px;
        padding: 26px 24px 22px; display: flex; flex-direction: column; align-items: center; gap: 10px; text-align: center;
      }
      .score { display: flex; align-items: baseline; justify-content: center; }
      .score .num { font-weight: 900; font-size: 104px; line-height: 1; letter-spacing: -3px; color: var(--green); }
      .score .den { font-weight: 800; font-size: 44px; color: var(--grey-text); margin-left: 2px; }
      .stars { display: flex; gap: 6px; }
      .stars svg { width: 30px; height: 30px; display: block; }
      .verdict-label { font-size: 21px; font-weight: 800; color: var(--black); letter-spacing: 1px; }
      .stats { display: flex; flex-direction: column; gap: 8px; width: 100%; flex: 1; justify-content: center; }
      .stat { display: flex; justify-content: space-between; align-items: baseline; padding: 12px 4px; border-bottom: 1px dashed var(--line); font-size: 21px; }
  ...
  <body>
    <div class="slide">
      <div class="text-block">
        ...
        <div class="title"><span><em>Avis</em></span><span>Rank Math</span></div>
        <div class="baseline">Le plugin SEO que j'utilise sur schoolsWP. Fonctions, assistant IA, tarifs et limites : mon test complet.</div>
        <div class="signature">
      ...
      <div class="visual">
        <div class="visual-inner">
          <div class="v-header">
            ...
            <span>Mon verdict</span>
          </div>
          <div class="verdict-card">
            <div class="score"><span class="num">5</span><span class="den">/5</span></div>
            <div class="stars">@@STARS@@</div>
            <div class="verdict-label">EXCELLENT, SANS R&Eacute;SERVE</div>
          </div>
          <div class="stats">
            <div class="stat"><span class="stat-key">Note WordPress.org</span><span class="stat-val">4,8 / 5</span></div>
            <div class="stat"><span class="stat-key">Sites actifs</span><span class="stat-val">4 M+</span></div>
            <div class="stat"><span class="stat-key">Version gratuite</span><span class="stat-val">Compl&egrave;te</span></div>
            <div class="stat"><span class="stat-key">Assistant IA</span><span class="stat-val">Inclus</span></div>
          </div>
          <div class="visual-footer">
            <span class="dot"></span>
            <span>Le plugin SEO de r&eacute;f&eacute;rence</span>
          </div>
        </div>
      </div>
    </div>
...
with open(os.path.join(d, "slide-00-hero-fr.html"), "w", encoding="utf-8") as f:
    f.write(html)
print("Generated", os.path.join(d, "slide-00-hero-fr.html"))
