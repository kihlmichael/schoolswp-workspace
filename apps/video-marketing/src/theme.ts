...
export const THEME = {
  ...
  scene2: { start: 600, duration: 750 },    // Présentation (25s)
  scene3: { start: 1350, duration: 1050 },  // Problèmes (35s)
  scene4: { start: 2400, duration: 1050 },  // Solutions (35s)
  scene5: { start: 3450, duration: 600 },   // Bénéfices (20s)
  scene6: { start: 4050, duration: 600 },   // Crédibilité (20s)
