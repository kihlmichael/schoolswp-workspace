...
8. **Ton par contexte** :
   ...
   - Social → conversationnel, engageant, leçons concrètes
...
14. **Mots à utiliser** : en clair, concrètement, étape par étape, testé et approuvé, actionnable, automatiser, structurer, optimiser, gagner du temps, levier de croissance, écosystème, méthode, système.
15. **Mots interdits** : disruptif, game changer, scalable, leverage, hack/growth hack, révolutionnaire, incroyable, le meilleur du marché, en un clic, sans effort, simplement (quand c'est pas simple), il suffit de.
...
## Visuel (quand applicable)

21. **Couleurs primaires** : `#00D400` (primary), `#00A100` (secondary), `#E668D4` (accent).
22. **Contrastes** : `#12111F` (darkest) → `#FAFBFD` (white bg).
23. **Typo** : Nunito Sans bold 700 (titres), Roboto regular 400 (body, 1.2rem).
24. **Style UI** : épuré, aéré, lisible, professionnel sans être froid, espaces généreux, moderne, accessible.
