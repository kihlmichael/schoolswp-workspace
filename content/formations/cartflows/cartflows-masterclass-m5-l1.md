...
Il vient de prendre une decision d'achat. Il a franchi la barriere psychologique la plus difficile du parcours : sortir sa carte et payer. Cette barriere est tombee. Et pendant les 30 a 60 secondes qui suivent, il est dans un etat de confiance maximale. Il est engage. Il a dit oui une premiere fois.

C'est exactement ce moment que tu vas exploiter avec les upsells post-achat. Et dans ce module, on va construire tout le systeme ensemble dans CartFlows.
...
Prenons un exemple concret. Tu vends une formation WordPress a 97 euros. Sans upsell, ton AOV est de 97 euros. Avec un upsell coaching a 197 euros qui est accepte par 15% des acheteurs, ton AOV passe a 126 euros. C'est 30 euros de plus par commande, sans un centime de publicite supplementaire.

Sur 100 ventes par mois, ca represente 3000 euros de chiffre d'affaires additionnel. Juste en ajoutant une page entre le checkout et la page de remerciement.

Et c'est la beaute du systeme : tu ne paies pas plus cher pour acquerir ces clients. Le cout d'acquisition est le meme. Tu maximises simplement la valeur de chaque client existant.
...
Mauvais upsell : le client achete une formation WooCommerce et tu lui proposes un ebook sur le jardinage. Zero rapport. Le taux d'acceptation sera proche de zero.

Bon upsell : le client achete une formation WooCommerce et tu lui proposes un pack de templates de pages produit optimisees. C'est la suite logique. Il veut creer sa boutique, tu lui donnes les outils pour aller plus vite.

Voici d'autres combinaisons qui fonctionnent :

- Formation basique → coaching personnalise
- Ebook → version video du meme contenu
- Abonnement 1 mois → upgrade vers 1 an (avec remise)
...
A la fin du module, tu auras un funnel complet : Landing Page → Checkout + Bump → Upsell → Downsell → Thank You. Chaque etape optimisee pour maximiser ta valeur par client.
...
Dans la prochaine lecon, on passe a la pratique. Tu vas creer ton premier upsell one-click dans CartFlows.

---

## Notes de production

- **Visuels** : schema chronologique parcours d'achat, comparaison pre/post-achat, graphique AOV, tableau exemples upsells
- **Captures d'ecran** : aucune capture CartFlows dans cette lecon (theorie pure)
- **Ton** : pedagogique et concret, appuye sur les chiffres
- **Duree estimee** : ~8 min a debit normal
- **Transition** : enchaine directement sur L5.2 (creation upsell one-click)
