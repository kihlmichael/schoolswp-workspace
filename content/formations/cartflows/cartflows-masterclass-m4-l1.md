...
Il coche. Il paie. Tu viens de gagner 17 euros de plus sans un gramme d'effort supplementaire. C'est ca, un order bump. Et c'est l'un des leviers les plus rentables de tout ton funnel.
...
Le client coche, le produit s'ajoute a la commande. Il decoche, il ne paie que le produit principal. C'est binaire, c'est simple, et c'est exactement pour ca que ca marche.
...
Formation en ligne a 47 euros. Le bump : un pack de templates pretes a l'emploi pour 17 euros. Le client achete la formation pour apprendre, le pack lui fait gagner du temps dans l'application. Complementaire, logique, prix faible par rapport au produit principal.

Produit physique a 89 euros. Le bump : une extension de garantie a 12 euros. Le client vient d'investir dans un produit, il veut le proteger. La decision est presque automatique.

Service de coaching a 197 euros. Le bump : un acces a la communaute privee pour 27 euros par mois. Le client veut progresser, la communaute l'aide a rester motive. Le bump renforce la valeur du produit principal.

Le point commun : le bump complete l'achat. Il ne le remplace pas, il ne le concurrence pas. Il l'enrichit.
...
L'order bump apparait sur la page de checkout, avant le paiement. Le client le voit pendant qu'il remplit le formulaire. Il coche ou il decoche. C'est integre au processus d'achat.
...
Si oui, c'est un bon candidat. Si le client doit reflechir pour comprendre le lien entre le bump et le produit principal, c'est mauvais signe. Le bump doit etre evident. "Tu achetes une formation ? Voila les templates qui vont avec." Pas de reflexion necessaire.

Deuxieme critere : le prix. Un bump doit representer entre 20 et 40 pourcent du prix du produit principal. Formation a 47 euros, bump entre 10 et 19 euros. Au-dela, le client commence a peser le pour et le contre, et tu perds l'effet "decision marginale".
...
Dans la prochaine lecon, on passe a la pratique : creer ton premier order bump dans CartFlows, etape par etape.
