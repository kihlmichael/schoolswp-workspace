...
Connecte-toi a ton compte. Dans la section "Downloads" ou "Mes telechargements", tu vas trouver le fichier ZIP de Power Coupons. Telecharge-le sur ton ordinateur.

Si tu as un abonnement CartFlows Pro, Power Coupons est inclus dans ton plan. Pas de cout supplementaire. Si tu l'achetes separement, le prix est indique sur la page du plugin.
...
Clique sur "Choisir un fichier", selectionne le ZIP que tu viens de telecharger. Clique sur "Installer maintenant".

L'installation prend quelques secondes. Une fois terminee, clique sur "Activer l'extension".

C'est la meme procedure que pour n'importe quel plugin premium. Rien de specifique ici.
...
La licence te donne droit aux mises a jour automatiques et au support. Sans licence active, le plugin fonctionne mais tu ne recois plus les mises a jour de securite et de fonctionnalites.
...
L'interface se decoupe en plusieurs sections.

Le tableau de bord. C'est ta vue d'ensemble : nombre de coupons actifs, utilisations recentes, performance globale.
...
Chacun de ces types sera couvert en detail dans une lecon dediee. On va commencer par le plus impactant : l'auto-application.
...
- **Visuels** : capture espace client cartflows.com, ecran installation WordPress, page licence, menu WooCommerce → Marketing → Power Coupons, slide 5 types de coupons
- **Donnees** : prix plugin si achat separe (verifier tarif actuel)
- **Transition** : enchaine sur LC.3 (auto-application)
