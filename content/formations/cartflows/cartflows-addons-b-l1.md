...
C'est pas un bug. C'est la realite du e-commerce.
...
Premiere raison : les frais inattendus. Le client voit un produit a 49€, il arrive au checkout et decouvre 8€ de livraison plus 2€ de frais de traitement. Le prix affiche n'est plus le prix reel. Il se sent trompe, il part.

Deuxieme raison : la creation de compte obligatoire. Le client veut acheter, pas creer un compte avec mot de passe, confirmation email, et tout le processus. Chaque champ supplementaire est un obstacle.

Troisieme raison : un processus de checkout trop long. Trop d'etapes, trop de pages, trop de clics. Le client perd patience.

Quatrieme raison : le manque de confiance. Pas de badge de securite, pas de politique de retour visible, pas de temoignages. Le client hesite et remet a plus tard. Plus tard, c'est jamais.
...
Ces 10 ventes, c'est le 30% qui a finalise. Si 70% ont abandonne, ca veut dire que 23 personnes supplementaires ont commence le checkout sans finir. 23 paniers a 50€ = 1 166€ de chiffre d'affaires potentiel qui s'evapore chaque mois.

Sur un an, ca fait pres de 14 000€ de ventes perdues. Pour une boutique qui fait 500€ par mois.

Et si tu fais 2 000€ par mois ? Le manque a gagner depasse 55 000€ par an.

Ces chiffres ne sont pas theoriques. Ils representent des gens qui etaient prets a acheter. Ils avaient choisi un produit, lance le checkout, et quelque chose les a arretes.
...
Le taux de recuperation moyen avec ce type d'outil : 20 a 30% des paniers abandonnes.
...
La version Pro a 59€ par an ajoute des regles de segmentation avancees, le suivi des paniers en temps reel, des templates d'emails supplementaires, et des integrrations avec des outils tiers.

Pour demarrer, la version gratuite est largement suffisante. C'est ce qu'on va configurer ensemble dans ce module.
...
- **Visuels** : slide statistique 70% (source Baymard Institute), tableau calcul 10 ventes/mois, capture page plugin WordPress.org
- **Donnees** : 70% taux abandon moyen (Baymard), 800K+ installs plugin, 20-30% taux recuperation moyen
- **Transition** : enchaine sur LB.2 (installation du plugin)
