...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, slides comparatives, screencast rapide d'une bio link page
...
Le coût. Linktree gratuit est très limité. Le plan Pro coûte 5 dollars par mois, soit 60 dollars par an. ClickWhale ? Inclus dans le plugin gratuit. Zéro coût supplémentaire.
...
Si tu as un compte Instagram pro ou créateur, tu n'as qu'un seul lien cliquable dans ta bio. Une bio link page te donne accès à tous tes liens importants depuis cette URL unique.

Même logique pour LinkedIn. Tu peux mettre ta bio link page comme site web dans ton profil.

Pour YouTube, tu peux l'ajouter dans la description de tes vidéos ou dans la section "À propos" de ta chaîne.
...
**Points clés** :
- Bio Link Page = page hébergée sur ton WordPress, pas un service tiers
- Zéro coût, zéro branding forcé, zéro abonnement
- Hébergée sur ton domaine = bon pour le SEO (indexable par Google)
- Jusqu'à 10 liens par page
- Cas d'usage : Instagram, LinkedIn, YouTube, cartes de visite

**Mots-clés SEO** : bio link page WordPress, alternative Linktree WordPress, ClickWhale link page, page de liens WordPress gratuit
...
**Durée** : 6 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast complet de la création
...
Étape 1 : dans le menu WordPress, va dans ClickWhale, puis Link Pages.
...
Étape 3 : remplis le titre de ta page. Par exemple : "Mes liens schoolsWP" ou "Links". Ce titre apparaîtra en haut de ta bio link page.
...
Étape 5 : dans l'onglet Contents, tu vois une zone vide avec un bouton pour ajouter des éléments. C'est un éditeur drag-and-drop. Tu as trois types de blocs disponibles.

[Montre le bouton d'ajout et la liste des blocs]

Le bloc Link : c'est un bouton cliquable. Tu mets une URL de destination et un texte. Quand le visiteur clique, il est redirigé vers cette URL.

Le bloc Heading : c'est un titre ou un séparateur visuel. Ça te permet d'organiser ta page en sections. Par exemple : "Mes formations", "Me suivre", "Contact".
...
Étape 6 : ajoutons un premier lien. Clique sur "Add Element", choisis "Link". Dans le champ URL, colle l'adresse de destination. Dans le champ texte, écris le libellé du bouton. Par exemple : "Découvre ma formation gratuite".

[Ajoute un deuxième lien]
...
Étape 7 : clique sur "Save" pour sauvegarder ta page. Puis clique sur "Preview" pour la voir en front-end.

[Montre la page en front-end]
...
**Points clés** :
- ClickWhale > Link Pages > Add New
- Titre + slug (court : "links", "bio", "liens")
- 3 onglets : Contents, Styles, SEO
- 3 types de blocs : Link, Heading, Post
- Toujours sauvegarder et prévisualiser avant de partager

**Mots-clés SEO** : créer bio link page ClickWhale, page de liens WordPress, ClickWhale link page tutorial
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de l'éditeur
...
Par exemple, tu mets un heading "Mes formations" suivi de tes liens de formation. Puis un heading "Me suivre" suivi de tes liens réseaux sociaux. Puis un heading "Contact" suivi de ton lien de contact.
...
Troisième type : le bloc Post. Tu sélectionnes un article WordPress existant dans un menu déroulant. ClickWhale affiche automatiquement le titre de l'article et un extrait.

[Sélectionne un article et montre le rendu]
...
Tous ces blocs sont réordonnables par drag-and-drop. Clique sur un bloc, maintiens, et déplace-le où tu veux. L'ordre dans l'éditeur est l'ordre d'affichage sur la page.
...
ClickWhale limite à 10 liens par page. C'est une contrainte saine. Ça t'oblige à prioriser.

Voici ma méthode. Classe tes liens en trois catégories.

Catégorie 1 : les liens qui génèrent du revenu ou des leads. Ta formation payante, ton formulaire d'inscription, ton produit. Mets-les en haut.

Catégorie 2 : les liens qui construisent la confiance. Ton dernier article, ta page à propos, tes témoignages. Mets-les au milieu.

Catégorie 3 : les liens de suivi. Tes réseaux sociaux, ton podcast, ta chaîne YouTube. Mets-les en bas.
...
**Points clés** :
- Bloc Link : URL de destination + texte du bouton → redirection au clic
- Bloc Heading : titre/séparateur visuel pour structurer la page
- Bloc Post : affiche un article WordPress existant (titre + extrait)
- Drag-and-drop pour réordonner les blocs
- 10 liens max → prioriser par valeur (revenu > confiance > suivi)

**Mots-clés SEO** : éditeur bio link ClickWhale, blocs link page WordPress, organiser page de liens
...
**Durée** : 6 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de l'onglet Styles
...
Premier réglage : Background Color. C'est la couleur de fond de toute ta page. Par défaut, c'est blanc.

[Change la couleur et montre la preview]

Tu peux choisir n'importe quelle couleur via le sélecteur ou entrer un code hexadécimal. Si ta charte graphique a une couleur de fond spécifique, c'est ici que tu la mets.
...
Troisième réglage : Button Color. C'est la couleur de tes boutons de lien. C'est l'élément le plus visible de ta page, celui sur lequel tes visiteurs vont cliquer.
...
Un point important : ta bio link page doit être cohérente avec le reste de ta marque. Si ton site utilise du bleu et du blanc, ne fais pas une bio link page rouge et noire.

Les couleurs à avoir sous la main avant de personnaliser :
- Ta couleur principale (boutons, accents)
- Ta couleur de fond
- Ta couleur de texte
- Les codes hexadécimaux exacts (pas "à peu près bleu")
...
**Points clés** :
- Onglet Styles : 4 réglages (Background, Text, Button, Hover)
- Contraste fort entre texte et fond = lisibilité
- Couleur de bouton = couleur d'action, doit ressortir
- Rester cohérent avec sa charte graphique
- CSS custom disponible pour la personnalisation avancée

**Mots-clés SEO** : personnaliser bio link page, style link page ClickWhale, couleurs page de liens WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de l'onglet SEO
...
Premier champ : Title tag. C'est le titre qui apparaît dans l'onglet du navigateur et dans les résultats Google. C'est la première chose que les gens voient.
...
Exemple : "Retrouve toutes les ressources schoolsWP : formation WordPress gratuite, derniers articles, newsletter et contact direct."
...
Les bons slugs pour une bio link page : /links, /bio, /liens, /go. Court, mémorisable, facile à dicter à voix haute.
...
Dernier point : les analytics. ClickWhale tracke automatiquement les vues de page et les clics sur chaque lien de ta bio link page. Pas besoin de configurer quoi que ce soit.
...
**Points clés** :
- Title tag : 50-60 caractères, clair et descriptif
- Méta description : 140-160 caractères, donne envie de cliquer
- Slug : court et mémorisable (/links, /bio, /liens)
- Hébergé sur ton domaine = indexable par Google, renforce ton autorité
- Analytics automatiques : vues et clics trackés sans configuration

**Mots-clés SEO** : SEO bio link page, optimiser page de liens Google, ClickWhale SEO, analytics link page WordPress
...
**Durée** : 6 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de l'ajout de formulaire
...
Étape 1 : ouvre ta bio link page dans l'éditeur, onglet Contents.

[Clique sur "Add Element" et montre le bloc "Forms"]
...
Étape 3 : un menu déroulant apparaît avec tous les formulaires disponibles sur ton site. ClickWhale détecte automatiquement les formulaires créés avec quatre plugins.

Contact Form 7, Fluent Forms, Ninja Forms et WPForms. Si tu utilises un de ces plugins et que tu as déjà créé un formulaire, il apparaîtra dans la liste.

[Sélectionne un formulaire Fluent Forms]

Étape 4 : sélectionne ton formulaire. Dans mon cas, je choisis un formulaire Fluent Forms qui capture juste le prénom et l'email. Simple, efficace.

[Montre la preview avec le formulaire intégré]
...
Quand utiliser un formulaire sur ta bio link page ?
...
Ma recommandation : utilise Fluent Forms. La version gratuite suffit pour un formulaire de capture email. C'est le plugin le plus léger et le mieux intégré avec l'écosystème WordPress.

Fluent Forms gratuit + ClickWhale Pro = capture de leads directement depuis ta bio link page, sans abonnement mensuel à un outil externe, sans friction pour le visiteur.
...
**Points clés** :
- Bloc Forms = fonctionnalité Pro uniquement
- 4 plugins supportés : Contact Form 7, Fluent Forms, Ninja Forms, WPForms
- Le formulaire détecte automatiquement les formulaires existants
- Cas d'usage : capture email, contact direct, inscription newsletter
- Stack recommandée : Fluent Forms (gratuit) + ClickWhale Pro

**Mots-clés SEO** : formulaire bio link page, capture leads ClickWhale, Fluent Forms ClickWhale, formulaire page de liens WordPress
...
Créer une bio link page ClickWhale complète, personnalisée et optimisée, prête à être partagée dans ta bio Instagram, ton profil LinkedIn ou ta chaîne YouTube.

### Ce que tu dois faire

#### 1. Crée une nouvelle Bio Link Page

- Va dans ClickWhale > Link Pages > Add New
- Titre : le nom de ta marque ou de ton site (ex: "Liens schoolsWP")
- Slug : `/links` ou `/bio`

#### 2. Ajoute 5 liens (dans cet ordre de priorité)

| # | Lien | Exemple de texte bouton | Type de bloc |
|---|------|------------------------|--------------|
| 1 | Ta formation ou ressource gratuite | "Accès à la formation gratuite" | Link |
| 2 | Ton dernier article de blog | (titre de l'article) | Post |
| 3 | Ta page d'inscription newsletter | "Reçois mes conseils chaque semaine" | Link |
| 4 | Ta page de contact | "Me contacter" | Link |
| 5 | Ta page à propos | "Qui suis-je ?" | Link |

Ajoute des blocs Heading pour structurer la page :
- "Ressources" avant les liens 1 et 2
- "Reste en contact" avant les liens 3, 4 et 5

#### 3. Ajoute 1 formulaire de capture email

- Prérequis : avoir Fluent Forms (ou un des 4 plugins supportés) installé avec un formulaire d'optin créé
- Le formulaire doit contenir au minimum : champ email + bouton d'envoi
- Place-le entre le lien 2 et le heading "Reste en contact"

#### 4. Personnalise les styles

- Background Color : la couleur de fond de ta charte graphique
- Text Color : une couleur contrastée avec le fond
- Button Color : ta couleur d'action principale
- Hover Color : une variante plus foncée/claire de ta couleur de bouton
...
- [ ] La page contient exactement 5 liens fonctionnels (chaque lien redirige vers la bonne URL)
- [ ] Au moins 2 blocs Heading structurent la page
- [ ] 1 formulaire de capture email est présent et fonctionnel
- [ ] Les couleurs sont cohérentes entre elles et avec ta charte graphique
- [ ] Le title tag fait entre 50 et 60 caractères
- [ ] La méta description fait entre 140 et 160 caractères
- [ ] Le slug est court (/links, /bio, /liens)
- [ ] La page s'affiche correctement en preview
...
[Background : #F8F9FA — gris clair]
  ...
  [ Accès à la formation gratuite ]    ← Lien 1 (bouton bleu)
  [ WordPress LMS : le guide complet ] ← Lien 2 (bloc Post)

  ┌─────────────────────────────┐
  │  Reçois la formation        │      ← Formulaire Fluent Forms
  │  [email@...]  [Envoyer]     │
  └─────────────────────────────┘

    --- Reste en contact ---

  [ Reçois mes conseils chaque semaine ] ← Lien 3
  [ Me contacter ]                       ← Lien 4
  [ Qui suis-je ? ]                      ← Lien 5
```
...
**Question 1** : Où est hébergée une Bio Link Page ClickWhale ?

- A) Sur les serveurs de ClickWhale
- B) Sur linktr.ee
- C) Directement sur ton site WordPress *(bonne réponse)*
- D) Sur un sous-domaine externe

---

**Question 2** : Combien de liens maximum peux-tu ajouter sur une Bio Link Page ?
...
**Question 3** : Quel type de bloc permet d'organiser visuellement ta page en sections ?

- A) Link
- B) Post
- C) Heading *(bonne réponse)*
- D) Forms

---

**Question 4** : Quel réglage de l'onglet Styles contrôle la couleur du bouton quand le visiteur passe la souris dessus ?

- A) Background Color
- B) Button Color
- C) Text Color
- D) Hover Color *(bonne réponse)*

---

**Question 5** : Quelle est la longueur recommandée pour le Title tag SEO d'une bio link page ?

- A) 20-30 caractères
- B) 50-60 caractères *(bonne réponse)*
- C) 100-120 caractères
- D) Pas de limite

---

**Question 6** : Pourquoi une bio link page ClickWhale a un avantage SEO sur Linktree ?

- A) ClickWhale a un meilleur algorithme SEO
- B) La page est sur ton domaine, donc Google peut l'indexer et l'autorité profite à ton site *(bonne réponse)*
- C) ClickWhale paye Google pour un meilleur classement
- D) Linktree bloque l'indexation de toutes ses pages

---

**Question 7** : Quels plugins de formulaires sont supportés par le bloc Forms de ClickWhale ?

- A) Gravity Forms, Formidable Forms, WPForms, Elementor Forms
- B) Contact Form 7, Fluent Forms, Ninja Forms, WPForms *(bonne réponse)*
- C) Tous les plugins de formulaires WordPress
- D) Uniquement le formulaire natif de ClickWhale

---

**Question 8** : Le bloc Forms sur une Bio Link Page est disponible dans quelle version de ClickWhale ?
