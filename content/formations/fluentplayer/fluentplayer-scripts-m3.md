...
- Capture d'email et Formulaire, disponibles dès la version gratuite
- CTA, Hotspot, Ad et Shortcode, en version Pro, qu'on verra au Module 4
...
- l'attention est sur la vidéo, pas dispersée sur la page
- tu choisis le moment exact, juste après avoir donné de la valeur
- la personne est déjà engagée, elle a cliqué sur play et elle est restée
...
**Points clés**
- Une couche interactive apparaît sur la vidéo, à un moment que tu choisis
- Capture d'email et Formulaire sont disponibles dès la version gratuite
- Capturer dans la vidéo profite du pic d'attention du spectateur
- Tu choisis le moment exact, juste après avoir donné de la valeur

**Mots-clés SEO**
- couche interactive vidéo
- FluentPlayer couche
- capture lead vidéo
- vidéo interactive WordPress
...
**Durée** : 10 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de configuration
...
- au tout début, en barrage : risqué, la personne n'est pas convaincue
- juste après ton meilleur conseil : le moment idéal
- au milieu, comme palier : correct si la vidéo est longue
...
**Points clés**
- Une couche de capture demande un moment, un message, une destination
- Pose la capture juste après ton meilleur moment de valeur
- Trop tôt, la personne n'est pas convaincue ; trop tard, elle est partie
- Le message promet quelque chose de concret à recevoir

**Mots-clés SEO**
- capture email vidéo
- FluentPlayer capture email
- générer des leads vidéo
- moment capture lead
...
**Durée** : 10 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast Fluent Forms + FluentPlayer
...
- Couche Capture d'email : rapide, un seul champ, le moins de friction.
- Couche Formulaire : plusieurs champs, plus de friction, mais plus d'informations.
...
**Points clés**
- La couche Formulaire affiche un formulaire Fluent Forms dans la vidéo
- Capture d'email pour la vitesse, Formulaire pour l'information
- Plus tu demandes de champs, moins de gens répondent : trois maximum
- Teste toujours la couche avant de publier

**Mots-clés SEO**
- Fluent Forms FluentPlayer
- formulaire dans une vidéo
- formulaire vidéo WordPress
- couche formulaire FluentPlayer
...
**Durée** : 10 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast FluentPlayer + FluentCRM
...
- un tag par vidéo-aimant, pour savoir quelle vidéo capture le plus
- un tag par sujet, pour regrouper les centres d'intérêt
- un tag de langue si tu publies en plusieurs langues
...
**Points clés**
- FluentPlayer se connecte directement à FluentCRM, sans intermédiaire
- La liste range le contact, le tag dit d'où il vient et ce qu'il veut
- Pose toujours un tag sur les contacts capturés par une couche vidéo
- Décide d'une convention de tags et tiens-t'y

**Mots-clés SEO**
- FluentPlayer FluentCRM
- connecter vidéo CRM WordPress
- tags FluentCRM
- segmentation leads vidéo
...
**Durée** : 8 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des intégrations Pro
...
- FluentCRM, en direct, vu à la leçon précédente
...
**Points clés**
- Mailchimp et les webhooks sont des destinations en version Pro
- L'intégration Mailchimp fonctionne comme celle de FluentCRM
- Un webhook permet de brancher n'importe quel service
- FluentCRM en direct reste le choix le plus simple

**Mots-clés SEO**
- FluentPlayer Mailchimp
- webhook FluentPlayer
- connecter vidéo email marketing
- intégration lead vidéo
...
- Convention de tags FluentCRM et checklist de couche de capture
- Projet : une vidéo-aimant gratuite qui capture des emails et les tague dans FluentCRM

### Environnement de démo
- Site WordPress schoolsWP avec FluentPlayer Pro, Fluent Forms et FluentCRM installés
- Une liste FluentCRM dédiée et une convention de tags préparée
- Un compte Mailchimp de démonstration avec une audience
- Une URL de webhook de test (n8n ou service équivalent)
...
1. Qu'est-ce qu'une couche interactive dans FluentPlayer ?
2. Quel est le meilleur moment pour déclencher une couche de capture d'email ?
3. Quand préférer une couche Formulaire à une couche Capture d'email ?
4. À quoi sert un tag, en plus de la liste, sur un contact capturé ?
5. Quelle destination choisir si ton outil email n'a pas d'intégration dédiée ?
