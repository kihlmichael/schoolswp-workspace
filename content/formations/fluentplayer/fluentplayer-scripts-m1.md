...
**Durée** : 8 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, tableau comparatif, slide arbre de décision
...
- le branding du lecteur : logo, couleurs, poster
- les chapitres
- la couche Formulaire et la couche Capture d'email
- les sources self-hosted, YouTube, Vimeo et audio
...
- les playlists, pour organiser un cours entier
- les analytics : rétention, complétion, viewers
- les couches CTA, Hotspot, Ad et Shortcode
- le contenu minuté et les sous-titres
- la reprise de lecture
- les presets personnalisables
...
- Tu découvres FluentPlayer ? Reste en gratuit, le temps de prendre tes marques.
- Tu veux juste capturer des emails dans tes vidéos ? Le gratuit suffit.
...
**Points clés**
- La version gratuite de FluentPlayer est utilisable en production, pas une démo
- Le gratuit couvre branding, chapitres, capture d'email
- Pro débloque playlists, analytics, CTA, ventes in-video, sources CDN
- Passe à Pro quand tu veux un système, pas juste un lecteur

**Mots-clés SEO**
- FluentPlayer Free vs Pro
- FluentPlayer prix
- FluentPlayer Pro fonctionnalités
- lecteur vidéo WordPress gratuit
...
**Durée** : 10 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, slides par source, arbre de décision
...
- ton propre site, en self-hosted
- YouTube
- Vimeo
- BunnyCDN
- Mux
...
- Avantage : simple, gratuit, tu es chez toi.
- Limite : une vidéo lourde pèse sur ton serveur et ralentit ton site.
...
Mux : du streaming haut de gamme, avec des analytics vidéo natifs. Plus cher, pour les projets exigeants.
...
**Points clés**
- FluentPlayer lit self-hosted, YouTube, Vimeo, BunnyCDN, Mux, HLS et audio
- Self-hosted convient aux petites vidéos, pas à une bibliothèque
- BunnyCDN est le meilleur choix pour un cours complet
- Mux vise les projets vidéo premium

**Mots-clés SEO**
- héberger vidéo WordPress
- BunnyCDN FluentPlayer
- source vidéo FluentPlayer
- self-hosted vs YouTube WordPress
...
**Durée** : 10 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, slides, démonstration de chargement
...
- chaque lecture sollicite ton serveur directement
- plusieurs spectateurs en même temps, et ton site rame
- ta page pèse lourd, tes Core Web Vitals chutent
...
Tant que le spectateur ne clique pas sur play, la vidéo ne se charge pas. Seule l'image s'affiche. Une image légère à la place d'une vidéo lourde, c'est une page qui s'ouvre vite.
...
- compresse tes fichiers avant de les mettre en ligne
- choisis une résolution adaptée, le 4K est rarement utile pour un tutoriel
...
**Points clés**
- Héberger de grosses vidéos sur ton serveur ralentit tout ton site
- Un CDN vidéo décharge la diffusion et garde ton site rapide
- L'image d'attente empêche la vidéo de se charger avant le clic
- Compresse et dimensionne tes vidéos avant la mise en ligne

**Mots-clés SEO**
- vitesse site WordPress vidéo
- Core Web Vitals vidéo
- CDN vidéo WordPress
- optimiser vidéo WordPress
...
- dashboard FluentPlayer
- gérer médias FluentPlayer
- réglages FluentPlayer
...
**Durée** : 8 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de création et d'application d'un preset
...
**Mots-clés SEO**
- preset FluentPlayer
- style lecteur vidéo WordPress
- personnaliser FluentPlayer
- branding vidéo cohérent
...
**Durée** : 8 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des réglages de branding
...
**Points clés**
- Le logo voyage avec la vidéo, où qu'elle soit vue
- Les couleurs d'accent reprennent ta charte de marque
- Le poster protège la vitesse de page et donne envie de cliquer
- La cohérence prime : enregistre ton branding dans un preset

**Mots-clés SEO**
- branding FluentPlayer
- logo sur vidéo WordPress
- poster vidéo FluentPlayer
- personnaliser lecteur vidéo
...
- Preset FluentPlayer aux couleurs de la marque, prêt à importer
- Projet : poser une vidéo de présentation 100% à la marque, légère et rapide

### Environnement de démo
- Site WordPress schoolsWP avec FluentPlayer Pro installé
- Un compte BunnyCDN de démonstration (pour la leçon 1.2 et 1.3)
- Deux ou trois vidéos de test, dont une volontairement lourde pour la démo de vitesse
...
1. Quelles couches interactives sont disponibles en version gratuite de FluentPlayer ?
2. Pour un cours en ligne de plusieurs heures de vidéo, quelle source est recommandée ?
3. Pourquoi héberger de grosses vidéos sur ton propre serveur pose-t-il problème ?
4. À quoi sert l'image d'attente (poster), au-delà de l'esthétique ?
5. Quel est l'intérêt de créer un preset de marque ?
