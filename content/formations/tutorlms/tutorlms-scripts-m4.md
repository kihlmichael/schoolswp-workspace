...
**Durée** : 6 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast du Course Builder
**Source** : Vidéos #3, #31 + doc course-builder
...
**Points clés** :
- Course Builder accessible via WP Admin > Tutor LMS > Courses > Add New ou via le front-end
- 3 sections : Course Info (base), Curriculum (contenu), Additional Settings (réglages)
- Bouton AI Studio intégré pour génération assistée
- Workflow recommandé : infos de base → curriculum → réglages → publication
- Sauvegarde en brouillon possible à tout moment

**Mots clés SEO** : TutorLMS course builder, créer cours TutorLMS, interface création cours WordPress LMS, TutorLMS backend
...
**Durée** : 7 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast complet de la section Course Info
...
L'image mise en avant, c'est la couverture de ton cours. Elle apparaît dans le catalogue, sur la page du cours, et dans les partages sociaux.

Taille recommandée : 700x430 pixels minimum. Format 16:10 idéalement. Utilise une image nette, avec du texte lisible si tu en mets. Pense que cette image sera souvent affichée en petit dans les listes.

[Clique sur "Set Featured Image" et montre le media uploader]
...
- Vidéo intro : optionnelle mais recommandée (1-3 min, bande-annonce)
- Maximum Students : 0 = illimité
- Difficulty Level : indicateur pour l'élève

**Mots clés SEO** : TutorLMS informations cours, configurer cours TutorLMS, description cours WordPress LMS, image cours TutorLMS
...
**Durée** : 8 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast complet de la section Curriculum
...
La section Curriculum est divisée en "Topics". Un topic, c'est un chapitre, un module, une grande partie de ton cours. À l'intérieur de chaque topic, tu places des leçons, des quiz, et si tu as l'add-on, des assignments.
...
Pour créer ton premier topic, clique sur le bouton "+ Add Topic" en bas de la section Curriculum.
...
Maintenant, on ajoute une leçon dans ce topic. Clique sur "+ Lesson". Une fenêtre modale s'ouvre.
...
**Points clés** :
- Curriculum = Topics (chapitres) contenant Lessons, Quizzes, Assignments
- Topic : titre obligatoire + résumé optionnel
- Lesson : titre, contenu riche, vidéo, image, fichiers exercice, option preview
- Quiz et Assignment se placent dans les topics comme les leçons
- Réorganisation par glisser-déposer (topics et leçons)
- Bonnes pratiques : 3-7 topics, 3-10 leçons/topic, 1 quiz/topic minimum

**Mots clés SEO** : TutorLMS curriculum, créer leçon TutorLMS, ajouter quiz TutorLMS, structurer cours WordPress LMS, TutorLMS topics
...
**Durée** : 7 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast de la section Additional Settings
...
Ajoute 3 à 5 points. Chaque point doit répondre à la question : "Après cette formation, je serai capable de...".
...
Quatrième bloc : matériels inclus. Liste les ressources que l'élève recevra en plus des leçons. Templates, checklists, fichiers sources, accès à un groupe privé, supports PDF.
...
Cinquième bloc : prérequis et instructions. Qu'est-ce que l'élève doit savoir ou avoir avant de commencer ? Un site WordPress installé ? Des connaissances de base en HTML ? Un compte hébergeur ?
...
Sixième bloc : les prérequis de cours. C'est différent du champ précédent. Ici, tu lies ton cours à d'autres cours de ta plateforme. Si l'élève n'a pas terminé le cours prérequis, il ne peut pas accéder à celui-ci.

Par exemple, ton cours "TutorLMS Avancé" peut exiger la complétion de "TutorLMS Débutant". Tape le nom du cours et sélectionne-le dans la liste.
...
Dernier bloc : les cours en direct. Si tu as l'add-on Google Meet ou Zoom, tu peux planifier des sessions live directement depuis le Course Builder. L'élève voit les sessions planifiées et peut rejoindre depuis sa page de cours.
...
**Points clés** :
- "What Will I Learn?" : 3-5 résultats concrets (compétences, pas descriptions)
- Target Audience : précis, l'élève doit se reconnaître
- Durée : saisie manuelle (heures + minutes), estimation réaliste
- Materials Included : augmente la valeur perçue du cours
- Requirements : prérequis techniques honnêtes
- Course Prerequisites : lié à d'autres cours (add-on)
- Attachments : fichiers globaux (add-on)
- Certificates : templates disponibles, délivrés auto à la complétion (add-on)
- Live Class : sessions Zoom/Meet intégrables (add-on)

**Mots clés SEO** : TutorLMS réglages cours, configurer certificat TutorLMS, prérequis cours TutorLMS, TutorLMS additional settings
...
**Durée** : 7 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast complet de AI Studio
...
Étape de configuration. Va dans Tutor LMS, puis Settings, puis l'onglet Advanced. Tu verras l'option "AI Studio". Active-la, puis colle ta clé API OpenAI dans le champ dédié. Sauvegarde.

[Montre le toggle AI Studio et le champ API key]
...
Clique dessus. Un champ de prompt apparaît. C'est là que tu décris ce que tu veux. Plus ta description est précise, meilleur sera le résultat.

Mauvais prompt : "Un cours sur WordPress". Bon prompt : "Un cours pour débutants sur la création d'un site e-commerce WordPress avec WooCommerce, 5 modules, orientation pratique, public cible : entrepreneurs qui lancent leur boutique en ligne".

[Écrit un prompt détaillé et clique sur "Generate Now"]

Clique sur "Generate Now". AI Studio génère un plan de cours complet avec des topics, des leçons, des assignments et des quiz.

[Montre le résultat généré]

Voilà le résultat. Des topics avec des titres, des leçons dans chaque topic, des quiz positionnés. Tu peux revoir l'ensemble avant de l'importer.

[Clique sur "Append the course"]
...
AI Studio ne se limite pas au plan de cours. Tu vois une petite icône AI à côté du champ titre ? Clique dessus.

[Clique sur l'icône et génère un titre]
...
Même chose pour la description. Clique sur l'icône AI, donne un brief, génère. Tu obtiens une description structurée que tu peux utiliser telle quelle ou affiner.
...
**Points clés** :
- AI Studio nécessite un compte OpenAI avec du crédit API (pas ChatGPT Plus)
- Configuration : Tutor LMS > Settings > Advanced > activer AI Studio + coller clé API
- 4 fonctionnalités : plan de cours complet, titre, description, image mise en avant
...
**Durée** : 7 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast complet de la monétisation
**Source** : Vidéo #12
...
Pour activer l'intégration, va dans Tutor LMS, Settings, puis cherche l'onglet ou la section "Monetization". Sélectionne "WooCommerce" comme moteur de monétisation. Sauvegarde.

[Montre le réglage Monetization avec WooCommerce sélectionné]
...
Deuxième option, plus rapide : depuis le Course Builder, dans la section prix, sélectionne un produit WooCommerce existant ou crée-en un nouveau directement. TutorLMS crée le produit WooCommerce pour toi avec le prix que tu indiques.

[Montre la sélection du produit et le champ prix]
...
- Configurer Stripe minimum pour les paiements carte bancaire
- Pas de produit WooCommerce lié = cours gratuit

**Mots clés SEO** : TutorLMS cours payant, vendre formation TutorLMS WooCommerce, monétiser cours WordPress, TutorLMS prix WooCommerce Stripe
...
Créer un cours complet dans TutorLMS, de la fiche d'information à la publication, en appliquant tout ce que tu as appris dans le Module 4. À la fin de cet exercice, tu auras un cours publié (ou en brouillon) avec un curriculum structuré, des réglages professionnels, et un prix.

## Prérequis

- TutorLMS installé et actif (version gratuite minimum, Pro recommandé)
- WooCommerce installé si tu veux définir un prix
- Accès admin à ton site WordPress
- Un sujet de cours en tête (voir suggestions ci-dessous si tu n'en as pas)

> **Pas d'idée de cours ?** Utilise l'un de ces sujets d'entraînement :
...
### 1. Crée un nouveau cours et remplis les informations de base

- Va dans Tutor LMS > Courses > Add New
- Remplis :
  - [ ] **Titre** : clair, descriptif, précis (pas "Mon cours")
  - [ ] **Description** : 150-300 mots, structurée en 3 parties (apprentissage, public, résultats)
  - [ ] **Catégorie** : crée-en une si nécessaire
  - [ ] **Image mise en avant** : 700x430 px minimum (utilise Canva ou AI Studio)
  - [ ] **Niveau de difficulté** : débutant, intermédiaire ou expert
- Sauvegarde en brouillon

### 2. Construis le curriculum (minimum 2 topics, 2 leçons chacun, 1 quiz)

- Crée au moins 2 topics avec des titres explicites
- Dans chaque topic, ajoute au moins 2 leçons :
  - [ ] **Topic 1** : 2 leçons minimum (titre + contenu ou placeholder)
  - [ ] **Topic 2** : 2 leçons minimum (titre + contenu ou placeholder)
  - [ ] **Quiz** : 1 quiz dans le topic 2 (au moins 3 questions)
- Pour chaque leçon :
  - [ ] Titre descriptif
  - [ ] Contenu (même un paragraphe suffit pour l'exercice)
  - [ ] Au moins 1 leçon avec une vidéo (YouTube embed ou upload)
- Vérifie l'ordre par glisser-déposer

### 3. Configure les réglages additionnels

- Remplis au minimum :
  - [ ] **What Will I Learn?** : 3-5 résultats concrets
  - [ ] **Target Audience** : public cible précis
  - [ ] **Durée totale** : estimation en heures/minutes
  - [ ] **Requirements** : prérequis techniques
- Optionnel mais recommandé :
  - [ ] Materials Included
  - [ ] Certificat (si add-on actif)
...
- [ ] Ouvre la page du cours en mode "Preview" ou dans un navigateur déconnecté
- [ ] Vérifie que le titre, la description et l'image s'affichent correctement
- [ ] Vérifie que le curriculum est visible et logique
- [ ] Vérifie que le prix et le bouton d'achat sont présents (si applicable)
- [ ] Vérifie que les objectifs d'apprentissage et le public cible apparaissent

### 6. Publie ou garde en brouillon

- Si tout est bon : clique sur "Publish"
- Si tu veux encore ajuster : garde en "Draft"

## Critères de validation

- [ ] Le cours a un titre clair et une description de 150+ mots
- [ ] L'image mise en avant est présente et en bonne résolution
- [ ] Le curriculum contient au moins 2 topics et 4 leçons
- [ ] Au moins 1 quiz est présent avec 3+ questions
- [ ] Au moins 1 leçon contient une vidéo
- [ ] Les réglages "What Will I Learn?" et "Target Audience" sont remplis
- [ ] Le cours a un prix défini (ou est explicitement gratuit)
- [ ] La page du cours s'affiche correctement côté visiteur

## Bonus (optionnel)

- [ ] Utilise AI Studio pour générer le plan initial, puis personnalise-le
- [ ] Ajoute une vidéo d'introduction sur la fiche du cours
- [ ] Active le "Lesson Preview" sur la première leçon pour donner un aperçu gratuit
- [ ] Ajoute un prérequis de cours si tu as un autre cours sur ta plateforme
...
**Question 1** : Quelles sont les 3 sections principales du Course Builder TutorLMS ?

- A) Titre, Contenu, Paiement
- B) Course Info, Curriculum, Additional Settings *(bonne réponse)*
- C) Description, Leçons, Certificats
- D) Topics, Quiz, Assignments

---

**Question 2** : Quelle taille minimum est recommandée pour l'image mise en avant d'un cours ?

- A) 300x200 pixels
- B) 500x300 pixels
- C) 700x430 pixels *(bonne réponse)*
- D) 1920x1080 pixels

---

**Question 3** : Dans le curriculum, quel est le rôle d'un "Topic" ?

- A) C'est une leçon individuelle avec du contenu vidéo
- B) C'est un conteneur qui regroupe des leçons, quiz et assignments *(bonne réponse)*
- C) C'est un tag pour catégoriser le cours
- D) C'est un prérequis pour accéder au cours

---

**Question 4** : Combien de topics par cours sont recommandés comme bonne pratique ?

- A) 1 à 2
- B) 3 à 7 *(bonne réponse)*
- C) 10 à 15
- D) Il n'y a pas de limite recommandée

---

**Question 5** : Qu'est-ce qu'AI Studio nécessite pour fonctionner ?

- A) Un abonnement ChatGPT Plus
- B) Un compte OpenAI avec du crédit API *(bonne réponse)*
- C) L'add-on TutorLMS AI (payant)
- D) Une connexion à Google Gemini

---

**Question 6** : Comment rendre un cours payant dans TutorLMS ?

- A) En activant l'option "Paid" dans les réglages du cours
- B) En liant le cours à un produit WooCommerce avec un prix *(bonne réponse)*
- C) En ajoutant un plugin de paiement Stripe directement dans TutorLMS
- D) En configurant PayPal dans les réglages TutorLMS

---

**Question 7** : Que se passe-t-il après qu'un élève a payé via WooCommerce ?

- A) L'administrateur doit valider l'inscription manuellement
- B) L'élève reçoit un email avec un lien d'activation
- C) L'élève est automatiquement inscrit au cours *(bonne réponse)*
- D) L'élève doit créer un compte séparément puis s'inscrire

---

**Question 8** : Dans le champ "What Will I Learn?" des réglages additionnels, quel type de contenu est recommandé ?

- A) Une description générale du cours en paragraphe
- B) Des compétences concrètes que l'élève maîtrisera après le cours *(bonne réponse)*
- C) La liste des outils et logiciels utilisés
- D) Le plan détaillé du curriculum avec les titres de leçons
