...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast du dashboard frontend
...
Le dashboard frontend est accessible depuis l'URL /dashboard de ton site. C'est une page générée automatiquement par TutorLMS à l'installation. Chaque utilisateur connecté y accède.

[Montre la vue d'ensemble du dashboard]
...
Étape 1 : la section "Enrolled Courses". C'est la liste de tous les cours auxquels l'étudiant est inscrit. Chaque carte affiche le titre du cours, la barre de progression en pourcentage, et un bouton pour reprendre là où il s'est arrêté.
...
Étape 2 : le menu latéral. Il contient plusieurs onglets. Dashboard pour la vue d'ensemble qu'on vient de voir. Enrolled Courses pour la liste complète. Wishlist pour les cours mis en favoris. Reviews pour les avis laissés. My Quiz Attempts pour l'historique des quiz. Order History pour les commandes si tu as un modèle payant. Settings pour modifier le profil et le mot de passe.

[Clique sur chaque onglet pour montrer]
...
La Wishlist permet à l'étudiant de mettre des cours en favoris avant de s'inscrire. Pratique si tu as un catalogue avec beaucoup de formations.
...
- Settings permet de modifier profil et mot de passe depuis le frontend

**Mots clés SEO** : TutorLMS dashboard étudiant, frontend dashboard TutorLMS, interface étudiant LMS WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast du dashboard instructeur puis admin
...
Étape 1 : le dashboard instructeur. Quand tu te connectes avec un compte instructeur, le dashboard change complètement. En haut, tu as des statistiques : nombre de cours créés, nombre total d'étudiants inscrits, revenus générés et nombre d'avis reçus.

[Montre les stats en détail]
...
Étape 2 : le menu latéral instructeur. Tu retrouves certains onglets du dashboard étudiant, plus des sections spécifiques. My Courses liste tous les cours que tu as créés. Announcements pour envoyer des messages à tes étudiants. Q&A pour répondre aux questions posées dans tes cours. Quiz Attempts pour voir les résultats de tes étudiants aux quiz. Withdrawals pour gérer tes demandes de retrait si tu utilises le système de commission.

[Clique sur My Courses]
...
Étape 3 : le dashboard admin. En tant qu'administrateur, tu as accès au back-office WordPress en plus du frontend. Dans le menu WordPress, tu trouves "Tutor LMS" avec un dashboard complet.
...
**Points clés** :
- Dashboard instructeur frontend : stats personnelles, gestion de ses cours, annonces, Q&A
- L'instructeur peut créer et gérer des cours sans accéder au back-office WordPress
- Dashboard admin : vue globale dans l'admin WordPress, graphiques, activité complète
- Si tu es seul, tu as accès aux deux vues (instructeur + admin)
- Le frontend suffit pour la gestion courante, le back-office pour la configuration

**Mots clés SEO** : TutorLMS dashboard instructeur, dashboard admin TutorLMS, gestion cours LMS WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast du menu Cours dans l'admin WordPress
...
Étape 1 : dans le menu WordPress à gauche, clique sur Tutor LMS puis sur Courses. Tu arrives sur la liste de tous tes cours.

[Montre la liste des cours]
...
Étape 2 : les filtres. En haut de la liste, tu as plusieurs options pour affiner l'affichage. Tu peux filtrer par statut : publié, brouillon, en attente. Par catégorie de cours. Ou par instructeur si tu en as plusieurs.

[Montre le tri par colonnes]
...
Étape 4 : quand tu survoles un cours dans la liste, des liens rapides apparaissent. Edit pour ouvrir l'éditeur complet. Quick Edit pour modifier le titre, le slug, la catégorie et le statut sans ouvrir la page entière. View pour voir le cours côté frontend. Duplicate pour créer une copie.
...
**Points clés** :
- Menu Tutor LMS > Courses : liste centrale de toutes tes formations
- Colonnes : titre, instructeur, catégorie, étudiants inscrits, date
- Filtres par statut, catégorie, instructeur
- Actions en masse : publier, brouillon, supprimer par lot
- Quick Edit pour modifications rapides sans ouvrir l'éditeur complet
- Edit ouvre l'éditeur de cours complet (détaillé au Module 3)

**Mots clés SEO** : TutorLMS menu cours, gestion cours TutorLMS WordPress, liste cours LMS
...
**Durée** : 4 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des menus Catégories et Tags
...
Étape 1 : va dans Tutor LMS puis Categories. L'écran est divisé en deux. À gauche, le formulaire pour créer une nouvelle catégorie. À droite, la liste des catégories existantes.
...
Étape 3 : le champ Parent. Tu peux créer une hiérarchie. Par exemple, une catégorie parente "WordPress" avec des sous-catégories "Plugins", "Thèmes", "Performance". Ça structure ton catalogue proprement pour les visiteurs.

[Crée une catégorie avec un parent pour montrer]
...
Étape 4 : les Tags. Le menu est identique dans sa structure : formulaire à gauche, liste à droite. Mais les tags n'ont pas de hiérarchie. Pas de parent, pas d'enfant. C'est à plat.

[Montre la création d'un tag]
...
**Points clés** :
- Catégories : hiérarchiques (parent/enfant), limitées à 2 niveaux
- Tags : non hiérarchiques, mots-clés transversaux
- Formulaire identique : nom, slug, description (+ parent pour les catégories)
- Assignation dans l'éditeur de cours (metaboxes à droite)
- Bonne pratique : 1 catégorie principale, 3-5 tags par cours

**Mots clés SEO** : TutorLMS catégories cours, tags cours TutorLMS, organiser catalogue LMS WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des menus Students et Instructors
...
Étape 1 : va dans Tutor LMS puis Students. Tu arrives sur la liste de tous les utilisateurs inscrits en tant qu'étudiants. L'affichage montre le nom, l'email, la date d'inscription, et le nombre de cours auxquels chaque étudiant est inscrit.
...
Étape 3 : en cliquant sur un étudiant, tu accèdes à son profil détaillé. Tu vois ses cours en cours, ses cours terminés, ses résultats de quiz, et son activité récente. C'est un suivi individuel complet.
...
Étape 4 : le menu Instructors. Même logique : une liste de tous les utilisateurs avec le rôle instructeur. Tu vois leur nom, leur email, le nombre de cours créés, et le nombre total d'étudiants.

[Montre les options d'un instructeur]
...
**Points clés** :
- Menu Students : liste, recherche, profil détaillé, inscription manuelle
- Menu Instructors : liste, approbation, permissions
- Trois rôles : étudiant (suit les cours), instructeur (crée les cours), admin (contrôle total)
- Ajout instructeur : changement de rôle WP ou candidature frontend avec validation
- Seul sur la plateforme = admin + instructeur cumulés

**Mots clés SEO** : TutorLMS gestion étudiants, rôle instructeur TutorLMS, utilisateurs LMS WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des menus Announcements et Q&A
...
Exemple concret : tu viens d'ajouter 3 nouvelles leçons à ton cours. Tu crées une annonce "3 nouvelles leçons disponibles" avec un résumé de ce qui a changé. Tous les étudiants inscrits à ce cours voient l'annonce dans leur dashboard.
...
Étape 4 : le système Q&A. Va dans Tutor LMS puis Q&A. Tu vois toutes les questions posées par tes étudiants, tous cours confondus.

[Montre la liste des Q&A]
...
Étape 5 : clique sur une question pour l'ouvrir. Tu vois le message de l'étudiant et un champ pour répondre. Tu peux écrire ta réponse et la publier. L'étudiant reçoit une notification.

[Montre la réponse publiée]
...
- Statuts Q&A : en attente, répondu, résolu
- Le Q&A fonctionne comme un mini-forum intégré à chaque cours

**Mots clés SEO** : TutorLMS annonces cours, Q&A TutorLMS, communication étudiants LMS WordPress
...
**Durée** : 5 min
**Type** : Vidéo HeyGen
**Écran** : Face caméra pour intro/conclusion, screencast des menus Quiz Attempts et Tools
...
Étape 1 : va dans Tutor LMS puis Quiz Attempts. Tu arrives sur la liste de toutes les tentatives de quiz de ta plateforme. Chaque ligne affiche l'étudiant, le quiz concerné, le cours associé, le score obtenu, et le statut : réussi ou échoué.

[Montre la liste avec des exemples]
...
Étape 2 : les filtres. Tu peux filtrer par cours, par date, ou par statut (réussi/échoué). Si tu veux voir tous les étudiants qui ont échoué à un quiz spécifique, c'est ici que tu cherches.

[Applique un filtre pour montrer]
...
Étape 3 : en cliquant sur une tentative, tu vois le détail question par question. La réponse de l'étudiant, la bonne réponse, les points obtenus. Pour les questions ouvertes ou à correction manuelle, tu peux attribuer les points ici.

[Montre la correction manuelle]
...
Étape 4 : le menu Tools. C'est le couteau suisse de TutorLMS. Tu y trouves plusieurs onglets.

[Montre l'onglet Pages]

Le premier onglet, Pages, te montre quelles pages WordPress sont assignées aux fonctions TutorLMS. La page Dashboard, la page Instructor Registration, la page Student Registration. Si une page est manquante, tu peux la régénérer depuis cet écran.

[Montre l'onglet Import/Export]
...
L'onglet Status affiche les informations système. Version de TutorLMS, version de PHP, limites serveur. C'est la première chose à vérifier si quelque chose ne fonctionne pas. Le support TutorLMS te demandera toujours ces informations.

[Montre les éventuels warnings]
...
**Points clés** :
- Quiz Attempts : suivi global des résultats, filtrable par cours/statut/date
- Détail question par question, correction manuelle des questions ouvertes
- 80% d'échecs sur un quiz = signal pour revoir la leçon
- Tools > Pages : vérification des pages assignées aux fonctions TutorLMS
- Tools > Import/Export : export JSON des cours pour migration ou duplication
- Tools > Status : informations système pour diagnostic

**Mots clés SEO** : TutorLMS quiz attempts, outils TutorLMS, suivi résultats quiz LMS WordPress
...
**Question 1**
Quelle URL donne accès au dashboard frontend de TutorLMS ?
...
**Réponse correcte** : C
**Explication** : Le dashboard frontend TutorLMS est accessible via /dashboard. C'est la page générée automatiquement à l'installation du plugin.

---

**Question 2**
Que peut faire un instructeur depuis le dashboard frontend que l'étudiant ne peut pas faire ?

- A) S'inscrire à des cours
- B) Créer et gérer ses propres cours
- C) Modifier son mot de passe
- D) Laisser un avis sur un cours

**Réponse correcte** : B
**Explication** : L'instructeur peut créer, éditer et gérer ses cours directement depuis le frontend, sans accéder au back-office WordPress. L'étudiant peut uniquement suivre les cours.

---

**Question 3**
Dans le menu Cours du back-office, que permet le Quick Edit ?

- A) Modifier les leçons et quiz d'un cours
- B) Modifier le titre, le slug, la catégorie et le statut
- C) Dupliquer un cours
- D) Exporter un cours en JSON

**Réponse correcte** : B
**Explication** : Le Quick Edit permet de modifier rapidement le titre, le slug, la catégorie et le statut sans ouvrir l'éditeur complet du cours.

---

**Question 4**
Quelle est la différence principale entre les catégories et les tags de cours ?

- A) Les catégories sont publiques, les tags sont privés
- B) Les catégories sont hiérarchiques, les tags ne le sont pas
- C) Les tags sont limités à 3 par cours
- D) Les catégories ne sont pas visibles sur le frontend

**Réponse correcte** : B
**Explication** : Les catégories supportent une hiérarchie parent/enfant. Les tags sont à plat, sans hiérarchie. Les deux sont visibles publiquement.

---

**Question 5**
Comment ajouter un instructeur sur ta plateforme TutorLMS ?

- A) Créer un nouveau site WordPress
- B) Changer le rôle d'un utilisateur ou activer la candidature instructeur
- C) Installer un plugin supplémentaire
- D) Envoyer un email d'invitation automatique

**Réponse correcte** : B
**Explication** : Deux méthodes : changer le rôle d'un utilisateur existant depuis WordPress, ou activer l'inscription instructeur avec validation admin.
...
**Réponse correcte** : B
**Explication** : Chaque annonce est associée à un cours spécifique. Seuls les étudiants inscrits à ce cours la voient dans leur dashboard.
...
**Réponse correcte** : B
**Explication** : Le Q&A est public au sein du cours. Tous les étudiants inscrits peuvent voir les questions et réponses, ce qui profite à tout le groupe.

---

**Question 8**
Dans le menu Tools, quel onglet utilises-tu pour migrer un cours vers un autre site ?
...
**Réponse correcte** : C
**Explication** : L'onglet Import/Export permet d'exporter des cours au format JSON et de les réimporter sur un autre site WordPress avec TutorLMS.
