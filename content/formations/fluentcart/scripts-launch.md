...
## Leçon 01.01 — Installer FluentCart Free et le Setup Wizard
...
ECRAN : Setup Wizard qui s'ouvre.
VO : Dès l'activation, FluentCart lance son assistant de configuration. Ne le saute pas, il te fait gagner du temps. Première question : quel type de boutique tu montes ? Produits digitaux, physiques, ou les deux. Choisis ce qui correspond à ton offre. Si tu vends des fichiers ou des accès, c'est digital.

ECRAN : Étape de création des pages.
VO : L'assistant te propose de créer automatiquement les pages essentielles : la boutique, le panier, le checkout, et l'espace client. Laisse-le faire. Ces quatre pages sont le squelette de ta boutique, et FluentCart les relie correctement entre elles.

ECRAN : Le tableau de bord FluentCart dans le menu.
...
## Leçon 01.02 — Configurer ton store (devise, adresse, taxes, pages)
...
ECRAN : Champ adresse de l'entreprise.
VO : Ensuite, l'adresse de ton entreprise. Elle sert à deux choses : tes factures, et le calcul des taxes. Renseigne-la complètement, même si ça te semble secondaire.

ECRAN : Réglages des numéros de commande.
VO : Tu peux définir le format de tes numéros de commande, un préfixe par exemple, et le point de départ. Ça paraît cosmétique, mais c'est utile pour ta compta et ton image.

ECRAN : Section taxes.
VO : Les taxes maintenant. On reste simple : tu poses le taux par défaut qui correspond à ton pays. On verra la fiscalité avancée, la TVA européenne et l'international, dans le module CART. Pour démarrer, le taux de base suffit.

ECRAN : Assignation des pages système.
...
## Leçon 01.03 — Créer ton premier produit
...
ECRAN : Titre, description, image.
VO : Tu renseignes le titre, une description claire, et au moins une image. Ne néglige pas l'image, c'est la première chose que ton acheteur regarde.

ECRAN : Champ prix.
VO : Le prix. Et si tu fais une promo, tu peux afficher un prix barré à côté du prix de vente. C'est un levier de conversion simple et honnête.

ECRAN : Cas produit digital, fichier à livrer.
VO : Pour un produit digital, tu associes le fichier que le client recevra, et tu peux limiter le nombre de téléchargements. Pour un produit physique, tu renseignes le poids et les dimensions, ça servira plus tard pour les frais de port.

ECRAN : Catégorie et brand.
VO : Tu assignes une catégorie, et si c'est pertinent, une marque. Ça structure ta boutique dès le départ, tu te remercieras quand ton catalogue grandira.
...
## Leçon 01.04 — Connecter Stripe et un second moyen de paiement
...
ECRAN : Activation d'un second gateway.
VO : Ensuite, tu actives un second moyen de paiement, PayPal ou Mollie. Pourquoi deux ? Parce que si Stripe a un incident un jour, tu ne veux pas perdre toutes tes ventes. Un second gateway, c'est ton filet de sécurité.

ECRAN : Vérification des devises supportées.
VO : Vérifie que chaque moyen de paiement supporte bien ta devise de boutique. Une incohérence ici, et un client ne pourra pas payer.

ECRAN : Réglage des webhooks Stripe.
VO : Et maintenant, l'étape que tout le monde oublie : les webhooks. Si Stripe te demande de configurer un webhook, fais-le tout de suite. Sans ça, une commande peut rester bloquée en attente alors que le client a déjà payé. Les webhooks, c'est ce qui dit à ta boutique que le paiement est passé.

ECRAN : Choix du gateway par défaut.
...
## Leçon 01.05 — Premier checkout, vente test, et statuts de commande
...
ECRAN : La commande dans le tableau de bord FluentCart.
VO : Tu retournes dans ton tableau de bord. La commande doit apparaître. Et là, on prend trente secondes pour comprendre les statuts : en attente, en traitement, terminée, remboursée. Ces statuts, c'est le langage de ta boutique. Une commande en attente qui ne bouge pas, souvent, c'est un webhook oublié, tu te souviens de la leçon précédente.

ECRAN : Lien de téléchargement, cas digital.
VO : Si c'est un produit digital, vérifie que le lien de téléchargement a bien été généré et qu'il fonctionne. C'est ce que ton client attend.

ECRAN : Remboursement de la commande test.
VO : Maintenant, teste un remboursement sur ta commande test. Tu dois savoir rembourser avant ta première vraie vente, pas le découvrir en panique devant un client mécontent.

ECRAN : Passage de Stripe en mode live.
...
## Leçon 01.06 — Emails de notification et reçu PDF
...
ECRAN : Notification admin.
VO : Tu actives aussi la notification admin, pour toi. À chaque vente, tu es prévenu. C'est motivant au début, et utile pour réagir vite.

ECRAN : Personnalisation de l'expéditeur.
VO : Personnalise l'expéditeur : ton nom, ton email. Un expéditeur générique finit en spam, et un email de confirmation dans les spams, c'est un client inquiet.

ECRAN : Reçu PDF / facture.
VO : Vérifie que le reçu, ou la facture en PDF, est bien joint ou accessible pour le client. C'est attendu, surtout pour un achat professionnel.

ECRAN : Achat test final.
