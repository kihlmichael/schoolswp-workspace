...
description: |
  Applique la psychologie du consommateur et la persuasion scientifique (JTBD, ELM, narrative transportation,
  loss/gain framing) pour produire du copy conversion avec références académiques. Utilise ce skill pour
  écrire une landing, une page de vente ou un email quand le copy doit être psychologiquement motivé et
  pas seulement descriptif.
  Déclenche pour "copy conversion psychologique", "persuasion copy", "JTBD copy", "copy émotionnel".
---
