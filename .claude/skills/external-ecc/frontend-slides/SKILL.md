...
> Frontmatter gutte pour eviter l'auto-trigger (collision possible avec aidesigner-frontend / external-cc-design). Invocation manuelle uniquement.
> Source : projects/everything-claude-code/skills/frontend-slides/. Le helper scripts/extract-pptx.py requiert le package Python python-pptx (non installe).
> Description originale : Create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Use for talks, pitchs, formation TutorLMS.
