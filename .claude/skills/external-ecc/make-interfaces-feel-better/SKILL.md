...
origin: ECC (community PR #1659 by linus707)
ecc-version: 2.0.0-rc.1
imported: 2026-05-24
---

> **Statut : import ECC manuel-only** (2026-05-24, passe 2 ECC v2.0.0-rc.1, commit 1e8c7e7).
> Frontmatter gutte pour eviter l'auto-trigger (collision possible avec aidesigner-frontend / design-review superpowers). Invocation manuelle uniquement (check-list QA UI).
> Source : projects/everything-claude-code/skills/make-interfaces-feel-better/.
> Description originale : Apply concrete design-engineering details that make interfaces feel polished. Use when reviewing or improving UI spacing, typography, borders, shadows, motion, hit areas, icons, text wrapping, and interaction states.
