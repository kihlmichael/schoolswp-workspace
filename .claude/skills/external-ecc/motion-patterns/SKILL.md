...
> Frontmatter gutte pour eviter l'auto-trigger. DEPENDANCE DURE de motion-foundations — toujours charger motion-foundations en premier. Invocation manuelle uniquement.
> Source : projects/everything-claude-code/skills/motion-patterns/.
> Description originale : Production-ready animation patterns for React / Next.js — button, modal, toast, stagger, page transitions, exit animations, scroll, and layout — built on motion-foundations tokens and springs.
