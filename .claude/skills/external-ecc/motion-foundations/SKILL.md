...
> Frontmatter gutte pour eviter l'auto-trigger. Foundation layer — motion-patterns en depend, donc charger ce skill EN PREMIER avant motion-patterns. Invocation manuelle uniquement.
> Source : projects/everything-claude-code/skills/motion-foundations/.
> Description originale : Motion tokens, spring presets, performance rules, device adaptation, accessibility enforcement, and SSR safety for React / Next.js using motion/react.
