...
description: >
  Pipeline complet de création YouTube Shorts pour la série schoolsWP "Jusqu'où est-ce trop ?".
  Utilise ce skill pour générer des Shorts WordPress à fort impact émotionnel : conception d'un
  personnage 3D scroll-stopper symbolisant WordPress, script dramatique 220-250 mots, et prompts
  image/vidéo séquentiels pour chaque beat narratif. Déclenche ce skill dès que l'utilisateur
  mentionne : YouTube Shorts, Shorts WordPress, série "Jusqu'où est-ce trop ?", personnage 3D
  WordPress, script dramatique Shorts, prompts visuels vidéo courte, scroll-stopper WordPress,
  ou création de contenu vidéo court pour schoolsWP. Même si l'utilisateur ne mentionne pas
  explicitement "skill" ou "shorts" — si le contexte implique une vidéo courte WordPress avec
  tension dramatique, utilise ce skill.
---
