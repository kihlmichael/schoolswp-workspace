...
description: |
  Guide d'utilisation de l'API Gemini sur Google Cloud Vertex AI. Utilise ce skill pour construire des
  applications avec Vertex AI, configurer les credentials et travailler avec les modèles Gemini via
  Vertex.
  Déclenche pour "Vertex AI", "Gemini Vertex", "Google Cloud AI", "API Vertex".
