...
description: |
  Expert de l'API WordPress Abilities (wp_register_ability, wp_register_ability_category,
  /wp-json/wp-abilities/v1/*, @wordpress/abilities) — définition des abilities, catégories, métadonnées,
  exposition REST et vérifications de permissions côté client.
  Déclenche pour "WordPress Abilities API", "wp_register_ability", "abilities WordPress".
