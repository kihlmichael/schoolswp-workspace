---
name: external-astra-spectra
description: |
  INVOCATION MANUELLE UNIQUEMENT, ne jamais auto-déclencher. Skill externe cloné depuis github.com/wpformation/claude-skill-astra-spectra (WPFormation) le 2026-05-20.

  Base de connaissance pour générer ou refondre des pages WordPress avec le plugin Spectra (48 blocs Gutenberg) : 24 pièges Spectra documentés, baselines design, 35+ patterns, 8 templates de pages, 15 scripts PHP de validation, workflows.

  IMPORTANT : schoolsWP tourne sur Kadence, PAS sur Spectra/Astra. Ce skill ne s'applique donc pas à la production de pages schoolswp.com. Il est conservé comme ressource de référence et matériau pour une future formation ou un tutoriel WordPress. Ne jamais l'utiliser pour créer ou refondre des pages schoolsWP : passer par les skills Kadence (landing-page-factory, mini-offre-page-de-vente, lead-magnet-schoolswp).

  Déclencher uniquement sur invocation explicite : "/external-astra-spectra", "skill astra-spectra", ou demande nommant explicitement Spectra dans un contexte formation ou tutoriel.
---
