...
name: kaizen
description: |
  Guide d'amélioration continue, d'anti-erreur et de standardisation. Utilise ce skill pour améliorer la
  qualité du code, refactoriser ou discuter d'améliorations de processus.
  Déclenche pour "amélioration continue", "refactoriser", "qualité du code", "standardisation", "kaizen".
risk: unknown
source: community
