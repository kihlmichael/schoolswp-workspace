---
name: dev-wordpress
description: Expert-level WordPress development guidance conforming to modern WordPress standards (blocks, themes, plugins, REST API, Interactivity API). Use when user asks about WordPress development, building blocks/plugins/themes, or needs coding guidance following WordPress best practices. Replaces generic or outdated patterns with current WordPress 6.9+ standards.
