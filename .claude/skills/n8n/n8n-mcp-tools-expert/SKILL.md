...
description: |
  Guide expert pour utiliser efficacement les outils MCP n8n-mcp. Utilise ce skill pour rechercher des
  nœuds, valider des configurations, accéder aux templates, gérer des workflows ou utiliser tout outil
  n8n-mcp. Fournit la sélection d'outil, les formats de paramètres et les patterns courants.
  Déclenche pour "outil n8n MCP", "n8n-mcp", "MCP n8n", "configurer un nœud via MCP".
