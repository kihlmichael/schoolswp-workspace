...
Use this skill whenever you are dealing with Remotion code to obtain domain-specific knowledge for advanced cases (FFmpeg, captions, 3D, voiceover, charts, Mediabunny).

For basics (hooks, components, sequences, animations), see the `remotion` skill first.
