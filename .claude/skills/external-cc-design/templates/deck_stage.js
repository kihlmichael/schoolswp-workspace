 ...
 *
 * ⚠️  CSS SELECTOR GOTCHA: at runtime this component moves every <section>
 *    into an inner <div> (the scaled canvas). After init the DOM becomes:
 *        <deck-stage>
 *          <div> (canvas)
 *            <section>…</section>
 *            <section>…</section>
 ...
 *          <div/>    (counter)
 *        </deck-stage>
 *    Therefore CSS like `deck-stage > section { … }` silently stops matching
 *    and your slides lose their sizing/padding. Use a descendant selector
 *    (`deck-stage section { … }`) or target the injected attributes
 *    (`section[data-screen-label]`, `section[data-om-validate]`).
 */
