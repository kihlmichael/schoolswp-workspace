---
name: open-design-docs-page
description: |
  [SCHOOLSWP-MODIFIED — see NOTICE.md] Skill MANUEL uniquement. Produit une page documentation 3 colonnes (left nav + body + right TOC, sticky rails, code blocks, callouts note/warning, anchor IDs). Pas de doublon avec skills schoolsWP existants. À utiliser pour : mockup doc API plugin custom, page d'aide produit standalone hors WP, démo doc technique pour brief client, présentation visuelle d'un runbook interne.
  ...
  Triggers manuels : "mockup doc technique", "page docs standalone", "doc API mockup", "présentation runbook visuel". Ne se déclenche PAS sur "docs" / "documentation" génériques.
triggers:
  - "mockup doc technique"
  - "page docs standalone"
  - "doc api mockup"
  - "présentation runbook visuel"
  - "docs page mockup"
od:
  mode: prototype
  platform: desktop
