---
name: open-design-pricing-page
description: |
  [SCHOOLSWP-MODIFIED — see NOTICE.md] Skill MANUEL uniquement. Produit une page pricing single-screen (hero + plan cards 2/3/4 tiers + comparison table + FAQ + footer CTA). Pure HTML, no JS, `<details><summary>` natif pour FAQ. À utiliser pour pages d'offres propres avec choix de tiers : pricing formation TutorLMS premium, bundle FluentCart, abonnement membership.

  NE PAS utiliser pour :
  - page de vente longue avec copy lourd (story, proof, objections, garantie) → mini-offre-page-de-vente
  - page affiliation tiers avec comparatif plugin → landing-page-factory
  ...
  Triggers manuels : "pricing 3 tiers", "page pricing comparatif", "tarifs formation", "bundle FluentCart pricing". Ne se déclenche PAS sur "pricing" / "plans" génériques.
triggers:
  - "pricing 3 tiers"
  - "page pricing comparatif"
  - "tarifs formation tutorlms"
  - "bundle fluentcart pricing"
  - "pricing tiers schoolswp"
od:
  mode: prototype
  platform: desktop
  scenario: sales
