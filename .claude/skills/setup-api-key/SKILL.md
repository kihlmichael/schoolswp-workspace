...
name: setup-api-key
description: |
  Guide la configuration d'une clé API ElevenLabs pour les outils MCP ElevenLabs. Utilise ce skill quand
  la clé ELEVENLABS_API_KEY doit être configurée, quand les outils ElevenLabs échouent par manque de clé,
  ou quand l'accès à ElevenLabs est nécessaire.
  Déclenche pour "clé API ElevenLabs", "configurer ElevenLabs", "ELEVENLABS_API_KEY".
license: MIT
