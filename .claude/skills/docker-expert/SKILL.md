...
name: docker-expert
description: |
  Expert Docker en conteneurisation : multi-stage builds, optimisation d'images, sécurité des
  conteneurs, Docker Compose et patterns de déploiement en production. Utilise ce skill pour
  tout ce qui concerne Docker — Dockerfile, images, réseaux, volumes, orchestration locale.
  Déclenche pour "Docker", "conteneur", "Dockerfile", "docker-compose", "image Docker",
  "optimiser une image", "sécuriser un conteneur", "multi-stage build".
---
