...
## Reporting & Analytics - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/#VPContent)

# Reporting & Analytics [​](https://docs.fluentcart.com/guide/reporting-analytics/\#reporting-analytics)
...
- **[Reports Dashboard Overview](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview):** A summary dashboard presenting key performance indicators (KPIs) at a glance.
- **[Orders Report](https://docs.fluentcart.com/guide/reporting-analytics/orders-report):** Detailed analytics focused on order performance, including sales by customer, day, and hour.
- **[Revenue Report](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report):** In-depth financial insights into your store's gross sales, net revenue, refunds, taxes, shipping, and discounts.
- **[Refunds Report](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report):** Specific analytics focused on refund activity, helping you understand refund trends and their impact.
- **[Subscription Report](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report):** Key insights into your recurring revenue, including active subscribers, total revenue, and retention rates.
- **[Retention Report](https://docs.fluentcart.com/guide/reporting-analytics/retention):** Subscription retention and churn analytics, filters, charts, lifetime value, and monthly summary data.
- **[Cohorts Report](https://docs.fluentcart.com/guide/reporting-analytics/cohorts):** Cohort-based subscription analytics with retention views, period comparisons, and exportable grouped data.
- **[Future Renewals Report](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals):** Forecasted subscription renewal revenue and counts to help with near-term cash flow planning.
- **[Product Report](https://docs.fluentcart.com/guide/reporting-analytics/product-report):** Detailed analytics on individual product performance, including units sold and top-selling items.
...
## Subscription Cohorts Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/cohorts

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/cohorts#VPContent)

# Subscription Cohorts Report [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#subscription-cohorts-report)
...
## Accessing the Cohorts Report [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#accessing-the-cohorts-report)

Go to your WordPress dashboard, navigate to **FluentCart Pro → [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)**, and select the **Cohorts** sub-tab under the **Subscriptions** category.

* * *

## Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#report-filters-and-controls)
...
## Cohort Visualization & Table [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#cohort-visualization-table)

The **Subscription Cohorts** table breaks down your data into a "heat map" format, making it easy to spot trends at a glance.

### 1\. Time Granularity [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#_1-time-granularity)
...
### 2\. Metric Selection [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#_2-metric-selection)
...
### 3\. Data Representation Styles [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#_3-data-representation-styles)
...
## Understanding the Cohort Table [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#understanding-the-cohort-table)
...
## Managing Cohort Data [​](https://docs.fluentcart.com/guide/reporting-analytics/cohorts\#managing-cohort-data)
...
## Customer Report Dashboard - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/customer-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/customer-report#VPContent)

# Customer Report Dashboard [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#customer-report-dashboard)
...
## Accessing the Customer Report [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#accessing-the-customer-report)

Go to your WordPress dashboard, then go to **FluentCart Pro** \> **Reports** in the top menu bar, and click on the **Customer** tab.

### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#report-filters-and-controls)
...
### Key Customer Growth Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#key-customer-growth-metrics)
...
### New Customers [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#new-customers)
...
### Comparison Breakdown [​](https://docs.fluentcart.com/guide/reporting-analytics/customer-report\#comparison-breakdown)
...
## Subscription Future Renewals Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/future-renewals

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals#VPContent)

# Subscription Future Renewals Report [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#subscription-future-renewals-report)
...
## Accessing Future Renewals [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#accessing-future-renewals)

Go to your WordPress dashboard, navigate to **FluentCart Pro → [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)**, and select the **Future Renewals** sub-tab under the **Subscriptions** category.

## Understanding Future Revenue Estimates [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#understanding-future-revenue-estimates)
...
## Upcoming Renewal Revenue Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#upcoming-renewal-revenue-chart)
...
## Feature Breakdown & Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#feature-breakdown-controls)
...
## Tips for Forecasting [​](https://docs.fluentcart.com/guide/reporting-analytics/future-renewals\#tips-for-forecasting)

> **Note:** These figures are estimates based on _active_ subscriptions. Actual revenue may vary slightly depending on factors like payment failures, mid-month cancellations, or manual plan changes.
...
## Orders Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/orders-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/orders-report#VPContent)

# Orders Report [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#orders-report)
...
#### Accessing the Orders Report [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#accessing-the-orders-report)

Go to your WordPress dashboard, then go to **FluentCart > [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)** in the side menu, and click on the **Orders** tab.

#### Filtering Your Report Data [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#filtering-your-report-data)
...
### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#report-filters-and-controls)
...
### Key Order Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#key-order-metrics)
...
#### Order Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#order-chart)
...
#### Customer Insights [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#customer-insights)
...
#### Orders Grouped By [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#orders-grouped-by)
...
#### Additional Order Analytics [​](https://docs.fluentcart.com/guide/reporting-analytics/orders-report\#additional-order-analytics)
...
## Product Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/product-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/product-report#VPContent)

# Product Report [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#product-report)
...
#### Accessing the Product Report [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#accessing-the-product-report)

Go to your WordPress dashboard, then go to **FluentCart > [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)** in the side menu, and click on the **Product** tab.

### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#report-filters-and-controls)
...
### Key Product Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#key-product-metrics)
...
#### Product Report Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#product-report-chart)
...
### Product Performance Comparison [​](https://docs.fluentcart.com/guide/reporting-analytics/product-report\#product-performance-comparison)
...
## Refunds Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/refunds-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report#VPContent)

# Refunds Report [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#refunds-report)
...
#### Accessing the Refunds Report [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#accessing-the-refunds-report)

Go to your WordPress dashboard, then go to **FluentCart** \> [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview) in the side menu, and click on the **Refunds** tab.

### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#report-filters-and-controls)
...
### Key Refund Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#key-refund-metrics)
...
#### Refunds Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#refunds-chart)
...
### Detailed Refund Analysis [​](https://docs.fluentcart.com/guide/reporting-analytics/refunds-report\#detailed-refund-analysis)
...
## Reports Dashboard Overview - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview#VPContent)

# Reports Dashboard Overview [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#reports-dashboard-overview)
...
## 360-Degree View: The Full Report Section [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#_360-degree-view-the-full-report-section)
...
## Reports Dashboard Overview (The Summary Page) [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#reports-dashboard-overview-the-summary-page)
...
### Reporting Overview - Gross Summary [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#reporting-overview-gross-summary)
...
### Key Performance Trends [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#key-performance-trends)
...
### Core Revenue and Geographic Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#core-revenue-and-geographic-metrics)
...
### Product and Customer Value [​](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview\#product-and-customer-value)
...
## Subscription Retention & Churn Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/retention

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/retention#VPContent)

# Subscription Retention & Churn Report [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#subscription-retention-churn-report)
...
## Accessing the Retention Report [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#accessing-the-retention-report)

Go to your WordPress dashboard, navigate to **FluentCart Pro → [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)**, and select the **Retention** sub-tab under the **Subscriptions** category.

## Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#report-filters-and-controls)
...
## Subscription & MRR Retention [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#subscription-mrr-retention)
...
## Retention Rate Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#retention-rate-chart)
...
## Lifetime Analysis [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#lifetime-analysis)
...
## Subscription & MRR Churn [​](https://docs.fluentcart.com/guide/reporting-analytics/retention\#subscription-mrr-churn)
...
## Revenue Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/revenue-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report#VPContent)

# Revenue Report [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#revenue-report)
...
#### Accessing the Revenue Report [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#accessing-the-revenue-report)

Go to your WordPress dashboard, then go to **FluentCart > [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)** in the side menu, and click on the **Revenue** tab.

### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#report-filters-and-controls)
...
### Key Revenue Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#key-revenue-metrics)
...
### Detailed Revenue Analysis [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#detailed-revenue-analysis)
...
#### Net Revenue Grouped By [​](https://docs.fluentcart.com/guide/reporting-analytics/revenue-report\#net-revenue-grouped-by)
...
## Sales Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/sales-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/sales-report#VPContent)

# Sales Report [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#sales-report)
...
#### Accessing the Sales Report [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#accessing-the-sales-report)

Go to your WordPress dashboard, then go to **FluentCart** \> **Reports** in the side menu, and click on the **Sales** tab.

### Filtering Your Report Data [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#filtering-your-report-data)
...
### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#report-filters-and-controls)
...
### Key Sales Metrics [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#key-sales-metrics)
...
#### Detailed Sales Analysis [​](https://docs.fluentcart.com/guide/reporting-analytics/sales-report\#detailed-sales-analysis)
...
## Subscription Report - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/reporting-analytics/subscription-report

[Skip to content](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report#VPContent)

# Subscription Report [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#subscription-report)
...
#### Accessing the Subscription Report [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#accessing-the-subscription-report)

Go to your WordPress dashboard, then go to **FluentCart > [Reports](https://docs.fluentcart.com/guide/reporting-analytics/reports-dashboard-overview)** in the side menu, and click on the **Subscription** tab.

### Report Filters and Controls [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#report-filters-and-controls)
...
### Subscription Chart [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#subscription-chart)
...
### Subscription Comparison [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#subscription-comparison)
...
### Detailed Subscription Analysis [​](https://docs.fluentcart.com/guide/reporting-analytics/subscription-report\#detailed-subscription-analysis)
