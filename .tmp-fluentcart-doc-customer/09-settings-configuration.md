...
## Settings & Configuration - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/#VPContent)

# Settings & Configuration [​](https://docs.fluentcart.com/guide/settings-configuration/\#settings-configuration)
...
- **[General Settings (Store Setup)](https://docs.fluentcart.com/guide/settings-configuration/general-settings):** Configure your basic store information, including name, logo, address, and currency settings.
- **[Pages Setup](https://docs.fluentcart.com/guide/settings-configuration/pages-setup):** Assign essential FluentCart functionalities (like shop, cart, and checkout) to specific WordPress pages using shortcodes.
- **[Single Product & Order Setup](https://docs.fluentcart.com/guide/settings-configuration/single-product-order-setup):** Customize how individual products are displayed and manage general order-related settings.
- **[Additional Info Settings](https://docs.fluentcart.com/guide/settings-configuration/additional-info-settings):** Configure various optional settings related to cart display, checkout requirements, and address fields.
- **[Payment Settings Overview](https://docs.fluentcart.com/guide/settings-configuration/payment-settings):** A general overview of available payment gateways and links to their detailed setup guides.
- **[Email Notifications](https://docs.fluentcart.com/guide/settings-configuration/email-notifications):** Manage and customize automated email communications sent to both administrators and customers.
- **[Roles & Permissions](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions):** Define and assign different user roles with specific access levels within your FluentCart store.
- **[Storage Settings](https://docs.fluentcart.com/guide/settings-configuration/storage-settings):** Configure where your digital product files and other assets are stored, including local and cloud (S3) options.
- **[Licensing Settings (FluentCart Product License)](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings):** Activate your FluentCart plugin license key to ensure regular updates and access to premium features.
...
URL : https://docs.fluentcart.com/guide/settings-configuration/additional-info-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/additional-info-settings#VPContent)
...
## Cart & Checkout Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings#VPContent)

# Cart & Checkout Settings [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#cart-checkout-settings)
...
## Accessing Cart & Checkout Settings [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#accessing-cart-checkout-settings)
...
#### Cart Icon in Body [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#cart-icon-in-body)
...
#### User Account Creation Mode [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#user-account-creation-mode)
...
#### Hide coupon field on checkout [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#hide-coupon-field-on-checkout)
...
#### Receipt Settings [​](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings\#receipt-settings)
...
## Checkout Fields Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/checkout-fields

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields#VPContent)

# Checkout Fields Settings [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#checkout-fields-settings)
...
## Accessing Checkout Fields Settings [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#accessing-checkout-fields-settings)
...
## Configuration Options [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#configuration-options)

The settings are organized into three sections, allowing you to control which fields appear during the checkout process.

### 1\. Basic Info [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#_1-basic-info)
...
### 2\. Billing Address [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#_2-billing-address)
...
### 3\. Shipping Address [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#_3-shipping-address)
...
### 4\. Agree Terms [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#_4-agree-terms)
...
## Saving Your Settings [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#saving-your-settings)

After configuring the checkout fields, click the **Save** button at the bottom right of the screen to apply your changes.

## Important: Toggle vs. Required [​](https://docs.fluentcart.com/guide/settings-configuration/checkout-fields\#important-toggle-vs-required)
...
## Email Configuration - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-configuration/

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/#VPContent)

# Email Configuration [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/\#email-configuration)
...
#### Mailing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/\#mailing-settings)
...
#### Notifications [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/\#notifications)
...
## 404 - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-notifications

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-notifications#VPContent)
...
## Features & Addons - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/features-addons

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/features-addons#VPContent)

# Features & Addons [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#features-addons)
...
## Accessing Features & Addon [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#accessing-features-addon)
...
## Managing Available Modules [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#managing-available-modules)
...
### 1\. Cloudflare Turnstile [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#_1-cloudflare-turnstile)
...
- **Configuration:** Once enabled, you will be prompted to enter your **Turnstile Site Key** and **Turnstile Secret Key** to complete the integration. See [Cloudflare Turnstile Integration](https://docs.fluentcart.com/guide/integrations/cloudflare-turnstile-integration) for full setup and key configuration.

### 2\. Product Licensing [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#_2-product-licensing)
...
- **When Active:** You can generate, manage, and sell license keys for products like software, plugins, or digital assets. See [Creating Licensed Product](https://docs.fluentcart.com/guide/product-types-creation/creating-digital-products-with-licenses) and [Managing Licenses](https://docs.fluentcart.com/guide/customer-dashboard/licenses) (customer-facing).
- **When Inactive:** All licensing-related fields and settings will be hidden from the product management screens.

### 3\. Stock Management [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#_3-stock-management)

Allows you to maintain a clear overview of your physical or limited digital inventory.

- **Function:** Enables inventory tracking tools, allowing you to set stock levels and display "In Stock" or "Out of Stock" messages to customers. For details, see [Inventory Management](https://docs.fluentcart.com/guide/product-types-creation/inventory-management).

### 4\. Order Bump [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#_4-order-bump)

A powerful tool for increasing your Average Order Value (AOV).

- **Function:** Allows you to offer relevant add-on products directly on the [checkout](https://docs.fluentcart.com/guide/settings-configuration/cart-checkout-settings) page, encouraging customers to add one more item to their purchase just before they pay. See [Order Bump](https://docs.fluentcart.com/guide/store-management/orders-management/order-bump) for creating and managing order bumps.

### 5\. Advanced Inventory [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#_5-advanced-inventory)
...
- **When Inactive:** The Inventory admin menu is hidden and no adjustment history is recorded. Per-product stock still works through the basic [Inventory Management](https://docs.fluentcart.com/guide/product-types-creation/inventory-management) screen.
- **When Active:** See [Advanced Inventory](https://docs.fluentcart.com/guide/product-types-creation/advanced-inventory) for the full workflow.

## Saving Your Changes [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#saving-your-changes)
...
> **Note:** Some features, like [Cloudflare Turnstile](https://docs.fluentcart.com/guide/integrations/cloudflare-turnstile-integration), may require additional configuration (such as API keys) immediately after activation to function correctly.

## Installing Licensed Addons (One-Click Installer) [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#installing-licensed-addons-one-click-installer)
...
### Prerequisites [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#prerequisites)

Before the one-click installer becomes available, make sure:

1. You have a valid FluentCart Pro license verified on the site. See [Licensing Settings](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings) for how to verify your license.
...
### How to Install an Addon in One Click [​](https://docs.fluentcart.com/guide/settings-configuration/features-addons\#how-to-install-an-addon-in-one-click)
...
## 404 - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/general-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/general-settings#VPContent)
...
## Managing Global Integrations - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/global-integrations

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/global-integrations#VPContent)

# Managing Global Integrations [​](https://docs.fluentcart.com/guide/settings-configuration/global-integrations\#managing-global-integrations)
...
## Accessing Global Integrations [​](https://docs.fluentcart.com/guide/settings-configuration/global-integrations\#accessing-global-integrations)
...
### The Global Integrations Dashboard [​](https://docs.fluentcart.com/guide/settings-configuration/global-integrations\#the-global-integrations-dashboard)
...
#### Adding a New Integration [​](https://docs.fluentcart.com/guide/settings-configuration/global-integrations\#adding-a-new-integration)
...
2. A dropdown menu will appear, listing all the available integrations, here you can configure [Webhook](https://docs.fluentcart.com/guide/integrations/webhook-integration), [FluentCRM](https://docs.fluentcart.com/guide/integrations/fluentcrm-integration) and [FluentCommunity](https://docs.fluentcart.com/guide/integrations/fluentcommunity-integration).
...
## Invoice & Packing Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings#VPContent)

# Invoice & Packing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#invoice-packing-settings)
...
### Step 1: Navigate to Invoice & Packing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#step-1-navigate-to-invoice-packing-settings)
...
### Step 2: Understand the Available Templates [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#step-2-understand-the-available-templates)
...
### Step 3: Customize a Template [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#step-3-customize-a-template)
...
### Step 4: Save Your Templates [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#step-4-save-your-templates)
...
### VAT Numbers on Generated PDFs [​](https://docs.fluentcart.com/guide/settings-configuration/invoice-packing-settings\#vat-numbers-on-generated-pdfs)
...
This makes the documents compliance-ready for B2B customers in the EU, UK, and other VAT jurisdictions. See [PDF Invoice Templates](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice) for the full PDF customization workflow.
...
## Your FluentCart Pro License - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/licensing-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings#VPContent)

# Your FluentCart Pro License [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#your-fluentcart-pro-license)
...
If you sell licensed digital products through FluentCart and want to see which **customer sites** have activated those licenses, see [Customer License Sites](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites) instead.

## Accessing Licensing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#accessing-licensing-settings)

1. From your WordPress dashboard, navigate to **FluentCart Pro > Settings** in the left sidebar.
2. Click on the **"Licensing"** tab.

## Managing Your License [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#managing-your-license)
...
## License Status [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#license-status)
...
## Viewing Activated Sites [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#viewing-activated-sites)
...
To learn how to filter the list, drill into a single site's detail view, and run common workflows like renewal outreach and license audits, see [Customer License Sites](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites).

## Installing Licensed Addons in One Click [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#installing-licensed-addons-in-one-click)
...
FluentCart pulls the addon directly from the licensed update server and activates it for you in a single step. For the full walkthrough, see [Features & Addons → Installing Licensed Addons](https://docs.fluentcart.com/guide/settings-configuration/features-addons#installing-licensed-addons-one-click-installer).
...
## Troubleshooting [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#troubleshooting)
...
## Saving Your Settings [​](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings\#saving-your-settings)
...
## Customer License Sites (Pro) - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites#VPContent)

# Customer License Sites (Pro) [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#customer-license-sites-pro)
...
If you're trying to activate **your own** FluentCart Pro license (the one you bought to unlock Pro features), see [Your FluentCart Pro License](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings) instead.
...
## Accessing Licensing Sites [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#accessing-licensing-sites)
...
## Sites List View [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#sites-list-view)
...
- **Site URL:** The domain where the license is active. Click the URL to open the **[Site Detail View](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites#site-detail-view)** for that site.
...
The list supports search, status filters, and the standard FluentCart **Advanced Filter** so you can scope it down by license, customer, expiration window, or activation count. See [Advanced Filtering](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites#advanced-filtering) below.

## Site Detail View [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#site-detail-view)
...
### Activated Licenses [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#activated-licenses)
...
### Customer Information [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#customer-information)
...
## Site Pages [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#site-pages)
...
## Advanced Filtering [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#advanced-filtering)

Above the Sites table you'll find the standard FluentCart filtering tools.

### Quick Filters [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#quick-filters)
...
### Advanced Filter [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#advanced-filter)
...
Combine multiple rules with AND/OR groups to build queries like _"all sites whose license expires in the next 30 days, run by customers in the EU"_ - useful for renewal outreach and compliance audits.

## Common Workflows [​](https://docs.fluentcart.com/guide/settings-configuration/managing-licensing-sites\#common-workflows)
...
## Pages Setup - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/pages-setup

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/pages-setup#VPContent)

# Pages Setup [​](https://docs.fluentcart.com/guide/settings-configuration/pages-setup\#pages-setup)
...
## Accessing Pages Setup [​](https://docs.fluentcart.com/guide/settings-configuration/pages-setup\#accessing-pages-setup)

Go to your WordPress dashboard, then go to **FluentCart Pro** \> **Settings** in the side menu, and click the **Pages Setup** tab.

## Assigning Core Pages [​](https://docs.fluentcart.com/guide/settings-configuration/pages-setup\#assigning-core-pages)

For each core FluentCart functionality, you need to select an existing WordPress page from the dropdown menu. Below each dropdown, FluentCart will display the specific **shortcode** that _must_ be added to the content of the selected page for the functionality to work correctly.

- **Select Shop Page:** Assigns the main page where all your products will be displayed.

  - **Required Shortcode:**`[fluent_cart_products]`
- **Select Customer Profile Page:** Assigns the page where customers can view and manage their personal details, orders, and downloads. You can find detailed information on what your customers see and manage in the [Customer Dashboard](https://docs.fluentcart.com/guide/customer-dashboard/index) section.
...
## Saving Your Settings [​](https://docs.fluentcart.com/guide/settings-configuration/pages-setup\#saving-your-settings)
...
## Payment Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/payment-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/payment-settings#VPContent)

# Payment Settings [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#payment-settings)
...
## Accessing Payment Settings [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#accessing-payment-settings)
...
## Configuration Options [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#configuration-options)
...
## Available Payment Gateways [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#available-payment-gateways)

FluentCart supports a wide range of global and regional payment processors to ensure your customers can pay with ease.

#### Global & Modern Solutions [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#global-modern-solutions)

- **[Stripe](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/stripe-settings):** A comprehensive platform to accept credit cards, debit cards, and popular local payment methods worldwide with a single integration.
- **[PayPal](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/paypal-settings):** One of the most trusted ways for customers to pay via their PayPal balance, linked bank accounts, or credit cards.
- **[Paddle](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/paddle-settings):** An all-in-one payment and tax solution (Merchant of Record) that handles global payments and compliance effortlessly.
- **[Square](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/square-settings):** Securely accept payments via Credit and Debit Cards, Apple Pay, Google Pay, and Cash App Pay.

#### Regional & Specialized Gateways [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#regional-specialized-gateways)

- **[Razorpay](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/razorpay-settings):** The leading payment gateway for businesses in India, supporting UPI, Netbanking, Cards, and Wallets.
- **[Flutterwave](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/flutterwave-settings):** A powerful solution for businesses to accept payments across Africa via Bank Transfer, Cards, and Mobile Money.
- **[Authorize.net](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/authorizenet-settings):** A highly reliable and established payment processor designed specifically for secure credit card and e-check transactions.
- **[Mercado Pago](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/mercado-pago-settings):** Mercado Pago is a widely used payment solution in Latin America that allows you to accept credit cards, debit cards, and local payment methods across multiple countries.
- **[Paystack](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/paystack-settings) :** Paystack is a modern payment gateway that helps businesses, particularly in Africa, accept payments from anyone, anywhere in the world via credit cards, bank transfers, and mobile money.

#### Manual Methods [​](https://docs.fluentcart.com/guide/settings-configuration/payment-settings\#manual-methods)

- **[Cash on Delivery (COD)](https://docs.fluentcart.com/guide/payments-checkout/connecting-payment-gateways/cash-on-delivery-settings):** Allows your customers to complete their purchase online and pay with physical cash upon the arrival of their order.
...
## Product Page Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/product-page

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/product-page#VPContent)

# Product Page Settings [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#product-page-settings)
...
## Accessing the Product Page Settings [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#accessing-the-product-page-settings)

1. From your WordPress dashboard, navigate to **FluentCart Pro** \> **Settings** in the left sidebar.
2. Click on the **Store Settings** tab.
3. Finally, select the **Product Page** section to see all available options.

## Configuration Options [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#configuration-options)

### 1\. Product Settings [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#_1-product-settings)
...
### 2\. Image Zooming [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#_2-image-zooming)
...
### 3\. Variation Display [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#_3-variation-display)
...
### 4\. Product Slug [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#_4-product-slug)
...
## Saving Your Settings [​](https://docs.fluentcart.com/guide/settings-configuration/product-page\#saving-your-settings)
...
## Roles & Permissions - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/#VPContent)

# Roles & Permissions [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/\#roles-permissions)
...
## Accessing Roles & Permissions [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/\#accessing-roles-permissions)

1. From your WordPress dashboard, navigate to **FluentCart Pro > Settings** in the left sidebar.
2. Click on the **"Roles And Permissions"** tab.

## Understanding Roles and Permissions [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/\#understanding-roles-and-permissions)

Here displays a list of users and their assigned FluentCart roles.

### 1\. Roles List Table [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/\#_1-roles-list-table)
...
### 2\. Adding New Roles [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/\#_2-adding-new-roles)

You can assign existing WordPress users to predefined **FluentCart** roles directly from this display.

- To add a new role, click the **"\+ Add Role"** button at the top right of the screen. This will open a modal to [add a new role](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/adding-new-roles/index).
...
## 404 - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/single-product-order-setup

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/single-product-order-setup#VPContent)
...
## Storage Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/storage-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/storage-settings#VPContent)

# Storage Settings [​](https://docs.fluentcart.com/guide/settings-configuration/storage-settings\#storage-settings)
...
- [Storage Overview](https://docs.fluentcart.com/guide/storage/)
- [Amazon S3 setup guide](https://docs.fluentcart.com/guide/storage/s3)
- [Cloudflare R2 setup guide](https://docs.fluentcart.com/guide/storage/r2)

Please head to the new pages above for the current documentation. The old location is kept here only so existing bookmarks and links keep working.
...
## Store Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/store-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/store-settings#VPContent)

# Store Settings [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#store-settings)
...
## Accessing General Settings [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#accessing-general-settings)

Go to your WordPress dashboard, then go to **FluentCart Pro** \> **Settings** in the side menu, and click on the **Pages Setup** tab.

## Configuring Your Store Details [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#configuring-your-store-details)

### 1\. General Information [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#_1-general-information)
...
### 2\. Store Mode [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#_2-store-mode)
...
### 3\. Store Address [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#_3-store-address)
...
### 4\. Currency [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#_4-currency)
...
### 5\. Payment View [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#_5-payment-view)
...
## Saving Your Settings [​](https://docs.fluentcart.com/guide/settings-configuration/store-settings\#saving-your-settings)
...
## Configuring Email Notifications - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification#VPContent)

# Configuring Email Notifications [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#configuring-email-notifications)
...
### Accessing the Notifications Screen [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#accessing-the-notifications-screen)

1. From your WordPress dashboard, navigate to **FluentCart Pro** \> **Settings**.
2. Click on the **Email Configuration** tab.
3. From the sub-menu, select **Notifications**.

### Managing Your Notifications [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#managing-your-notifications)
...
#### Available Notifications: [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#available-notifications)
...
#### Enabling or Disabling Notifications [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#enabling-or-disabling-notifications)
...
### Customizing an Email Notification [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#customizing-an-email-notification)
...
#### Email Subject [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#email-subject)
...
#### Email Body Type [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#email-body-type)
...
#### Customizing the Email Body [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#customizing-the-email-body)
...
#### Package Merge Tags [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/configuring-email-notification\#package-merge-tags)
...
## Mailing Settings - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings#VPContent)

# Mailing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings\#mailing-settings)
...
### Accessing Mailing Settings [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings\#accessing-mailing-settings)

1. From your WordPress dashboard, navigate to **FluentCart Pro** \> **Settings**.
2. Click on the **Email Configuration** tab. The **Mailing Settings** page opens by default.

### Configuration Options [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings\#configuration-options)
...
- **Reply to Name _(Optional)_:** If you want replies to be addressed to a different name than the sender, enter it here.
- **Reply to Email _(Optional)_:** The email address where customer replies to your notification emails will be delivered. If left empty, replies will go to the **From Email** address.
...
- **Admin Email Address:** The email address where FluentCart will send all administrative notifications. By default, this is pre-filled with `{{wp.admin_email}}`, which automatically pulls the primary administrator email from your WordPress settings. You can replace this with any specific address if needed.

### Saving Your Changes [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/mailing-settings\#saving-your-changes)
...
## PDF Invoice Templates - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice#VPContent)

# PDF Invoice Templates [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#pdf-invoice-templates)
...
## Step 1: Install and Activate the Fluent PDF Addon [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#step-1-install-and-activate-the-fluent-pdf-addon)
...
1. Make sure your FluentCart Pro license is verified on the site. See [Licensing Settings](https://docs.fluentcart.com/guide/settings-configuration/licensing-settings) if you haven't done this yet.
...
## Step 2: Install Required Fonts [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#step-2-install-required-fonts)
...
4. You will be redirected to a setup page with a blue **Install Fonts** button. Click it. _(Don't worry-this is a quick, one-time process! You will never have to do this again)._

![PDF Invoice](https://docs.fluentcart.com/images/store-management/pdf-invoice/pdf-4.webp)

## Step 3: Choose a Template to Edit [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#step-3-choose-a-template-to-edit)
...
## Step 4: Designing Your PDF (The Fun Part!) [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#step-4-designing-your-pdf-the-fun-part)
...
### 1\. Drag and Drop Blocks [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#_1-drag-and-drop-blocks)
...
### 2\. Using "Smart Tags" (Dynamic Data) [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#_2-using-smart-tags-dynamic-data)
...
#### Tax & EU VAT Smart Tags [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#tax-eu-vat-smart-tags)
...
- `{{order.tax_breakdown}}` - Renders a tidy table of every tax line on the order (e.g. "VAT 19%", "Shipping Tax"). For reverse-charge orders, the amount column shows **Charge reversed** and an automatic footnote, _"\\* Tax to be paid on reverse charge basis"_, is appended below the table.
...
#### Customer VAT Number on Receipts [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#customer-vat-number-on-receipts)
...
VAT numbers are captured during checkout via the EU VAT field. To learn how to enable and configure VAT collection for your store, see [Configuring European Union (EU) VAT](https://docs.fluentcart.com/guide/tax-&-duties/european-union-vat).

![PDF Invoice](https://docs.fluentcart.com/images/store-management/pdf-invoice/pdf-6.webp)

## Step 5: Test and Save Your Masterpiece [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/pdf-invoice\#step-5-test-and-save-your-masterpiece)
...
## Reminders - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders#VPContent)

# Reminders [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#reminders)
...
### Accessing Reminders [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#accessing-reminders)

1. From your WordPress dashboard, navigate to **FluentCart Pro** \> **Settings**.
2. Click on the **Email Configuration** tab.
3. From the sub-menu, select **Reminders**.

### Enabling Reminder Emails [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#enabling-reminder-emails)
...
### Configuring Subscription Reminders [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#configuring-subscription-reminders)
...
#### Trial Ending [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#trial-ending)
...
#### Renewal Reminders [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#renewal-reminders)

This reminder notifies customers before an upcoming subscription renewal charge.

- **Yearly _(Recommended)_:** Check to send a renewal reminder for yearly subscriptions. You can set the number of days before the billing date. The accepted range is **Min: 7, Max: 90**. The default is **30 days**.
...
### Saving Your Changes [​](https://docs.fluentcart.com/guide/settings-configuration/email-configuration/reminders\#saving-your-changes)
...
## Adding New Roles - FluentCart Documentation
URL : https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/adding-new-roles/

[Skip to content](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/adding-new-roles/#VPContent)

# Adding New Roles [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/adding-new-roles/\#adding-new-roles)
...
## Steps to Add a New Role [​](https://docs.fluentcart.com/guide/settings-configuration/roles-permissions/adding-new-roles/\#steps-to-add-a-new-role)
